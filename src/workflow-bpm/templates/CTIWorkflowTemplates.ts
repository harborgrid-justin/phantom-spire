...
export const CTI_WORKFLOW_TEMPLATES: Record<string, IWorkflowDefinition> = {
  ...
  APT_RESPONSE: {
    ...
    description:
      'Comprehensive workflow for responding to APT indicators and campaigns',
    ...
    triggers: [
      {
        ...
        description:
          'Triggered when APT indicators are detected in the environment',
        enabled: true,
        configuration: {
        ...
        conditions: [
          {
            expression:
              'event.confidence >= 80 && event.severity === "critical"',
    ...
    steps: [
      ...
      // Validate Indicators
      {
        ...
        type: StepType.TASK,
        description:
          'Validate APT indicators against threat intelligence sources',
        position: { x: 50, y: 200 },
        configuration: {
      ...
      // Identify Affected Systems
      {
        ...
        type: StepType.TASK,
        description:
          'Identify systems that may be affected by the APT campaign',
      ...
      // Containment Decision
      {
        ...
        conditions: [
          {
            expression:
              'variables.threatLevel === "critical" || variables.riskScore > 8',
            description:
              'High threat level or risk score requires immediate containment',
          },
        ],
        errorHandling: {
          strategy: 'fail',
      ...
      // Block Indicators
      {
        ...
        type: StepType.TASK,
        description:
          'Block identified malicious indicators across security controls',
  ...
  MALWARE_ANALYSIS: {
    ...
    description:
      'Comprehensive automated malware analysis and intelligence generation',
    ...
    triggers: [
      {
        ...
        description:
          'Triggered when a malware sample is submitted for analysis',
        enabled: true,
        configuration: {
    ...
    steps: [
...

      {
        ...
        type: StepType.DECISION,
        description:
          'Decide if dynamic analysis is needed based on static results',
        ...
        conditions: [
          {
            expression:
              'variables.staticResults.suspicious === true || variables.staticResults.unknownSample === true',
            description:
              'Suspicious or unknown samples require dynamic analysis',
          },
        ],
        errorHandling: {
          strategy: 'skip',
...
export const MALWARE_ANALYSIS_WORKFLOW =
  CTI_WORKFLOW_TEMPLATES.MALWARE_ANALYSIS;
...
export const VULNERABILITY_MANAGEMENT_WORKFLOW =
  CTI_WORKFLOW_TEMPLATES.VULNERABILITY_MANAGEMENT;
export const THREAT_HUNT_CAMPAIGN_WORKFLOW =
  CTI_WORKFLOW_TEMPLATES.THREAT_HUNT_CAMPAIGN;
export const COMPLIANCE_AUDIT_WORKFLOW =
  CTI_WORKFLOW_TEMPLATES.COMPLIANCE_AUDIT;
