...
interface InfrastructureMappingComponentProps {
...
const InfrastructureMappingComponent: React.FC<InfrastructureMappingComponentProps> = ({ onNavigate }) => {
...
export default InfrastructureMappingComponent;