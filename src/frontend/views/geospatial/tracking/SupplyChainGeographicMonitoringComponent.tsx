...
interface SupplyChainGeographicMonitoringComponentProps {
...
const SupplyChainGeographicMonitoringComponent: React.FC<SupplyChainGeographicMonitoringComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic supply chain visibility and security
        </Typography>
...
export default SupplyChainGeographicMonitoringComponent;