...
interface IotDeviceGeolocationComponentProps {
...
const IotDeviceGeolocationComponent: React.FC<IotDeviceGeolocationComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          IoT device location tracking and management
        </Typography>
...
export default IotDeviceGeolocationComponent;