...
interface PersonnelLocationServicesComponentProps {
...
const PersonnelLocationServicesComponent: React.FC<PersonnelLocationServicesComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Employee location services for security and safety
        </Typography>
...
export default PersonnelLocationServicesComponent;