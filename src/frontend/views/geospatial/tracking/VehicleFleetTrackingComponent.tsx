...
interface VehicleFleetTrackingComponentProps {
...
const VehicleFleetTrackingComponent: React.FC<VehicleFleetTrackingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Corporate vehicle fleet location and security
        </Typography>
...
export default VehicleFleetTrackingComponent;