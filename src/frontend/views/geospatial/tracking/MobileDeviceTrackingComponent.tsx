...
interface MobileDeviceTrackingComponentProps {
...
const MobileDeviceTrackingComponent: React.FC<MobileDeviceTrackingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Enterprise mobile device location and security
        </Typography>
...
export default MobileDeviceTrackingComponent;