...
interface FacilitySecurityMappingComponentProps {
...
const FacilitySecurityMappingComponent: React.FC<FacilitySecurityMappingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Physical facility security and access mapping
        </Typography>
...
export default FacilitySecurityMappingComponent;