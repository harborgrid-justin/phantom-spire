...
interface GlobalAssetInventoryComponentProps {
...
const GlobalAssetInventoryComponent: React.FC<GlobalAssetInventoryComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Worldwide asset inventory with geographic context
        </Typography>
...
export default GlobalAssetInventoryComponent;