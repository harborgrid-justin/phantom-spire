...
interface RegulatoryComplianceMappingComponentProps {
...
const RegulatoryComplianceMappingComponent: React.FC<RegulatoryComplianceMappingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic regulatory compliance requirements
        </Typography>
...
export default RegulatoryComplianceMappingComponent;