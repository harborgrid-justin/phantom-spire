...
interface JurisdictionRiskAssessmentComponentProps {
...
const JurisdictionRiskAssessmentComponent: React.FC<JurisdictionRiskAssessmentComponentProps> = ({ onNavigate }) => {
      ...
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        <Box display="flex" alignItems="center" mb={2}>
          ...
          <Typography variant="h4" component="h1">
            ⚖️ Jurisdiction Risk Assessment
          </Typography>
        </Box>
        <Typography variant="body1" color="text.secondary" paragraph>
          Legal jurisdiction risk analysis and mapping
        </Typography>
...
export default JurisdictionRiskAssessmentComponent;