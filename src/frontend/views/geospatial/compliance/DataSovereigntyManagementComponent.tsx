...
interface DataSovereigntyManagementComponentProps {
...
const DataSovereigntyManagementComponent: React.FC<DataSovereigntyManagementComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Data sovereignty compliance and geographic restrictions
        </Typography>
...
export default DataSovereigntyManagementComponent;