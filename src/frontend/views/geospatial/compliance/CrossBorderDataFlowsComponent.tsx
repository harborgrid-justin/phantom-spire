...
interface CrossBorderDataFlowsComponentProps {
...
const CrossBorderDataFlowsComponent: React.FC<CrossBorderDataFlowsComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          International data transfer compliance monitoring
        </Typography>
...
export default CrossBorderDataFlowsComponent;