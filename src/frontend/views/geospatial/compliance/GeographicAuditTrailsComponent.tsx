...
interface GeographicAuditTrailsComponentProps {
...
const GeographicAuditTrailsComponent: React.FC<GeographicAuditTrailsComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Location-based audit trail management
        </Typography>
...
export default GeographicAuditTrailsComponent;