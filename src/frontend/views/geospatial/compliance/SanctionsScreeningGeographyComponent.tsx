...
interface SanctionsScreeningGeographyComponentProps {
...
const SanctionsScreeningGeographyComponent: React.FC<SanctionsScreeningGeographyComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic sanctions and embargo compliance
        </Typography>
...
export default SanctionsScreeningGeographyComponent;