...
interface GeographicClusteringAnalysisComponentProps {
...
const GeographicClusteringAnalysisComponent: React.FC<GeographicClusteringAnalysisComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Statistical clustering analysis of geographic data
        </Typography>
...
export default GeographicClusteringAnalysisComponent;