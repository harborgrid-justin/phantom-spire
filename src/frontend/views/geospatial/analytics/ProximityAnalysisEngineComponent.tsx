...
interface ProximityAnalysisEngineComponentProps {
...
const ProximityAnalysisEngineComponent: React.FC<ProximityAnalysisEngineComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Distance-based threat correlation and analysis
        </Typography>
...
export default ProximityAnalysisEngineComponent;