...
interface PredictiveGeographicModelingComponentProps {
...
const PredictiveGeographicModelingComponent: React.FC<PredictiveGeographicModelingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Predictive modeling for geographic threat evolution
        </Typography>
...
export default PredictiveGeographicModelingComponent;