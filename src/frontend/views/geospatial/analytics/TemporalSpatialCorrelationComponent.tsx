...
interface TemporalSpatialCorrelationComponentProps {
...
const TemporalSpatialCorrelationComponent: React.FC<TemporalSpatialCorrelationComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Time-space correlation analysis for threat hunting
        </Typography>
...
export default TemporalSpatialCorrelationComponent;