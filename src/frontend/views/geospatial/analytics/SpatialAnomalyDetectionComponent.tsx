...
interface SpatialAnomalyDetectionComponentProps {
...
const SpatialAnomalyDetectionComponent: React.FC<SpatialAnomalyDetectionComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          AI-powered spatial anomaly identification
        </Typography>
...
export default SpatialAnomalyDetectionComponent;