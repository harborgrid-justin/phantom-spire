...
interface NetworkTopologyMappingComponentProps {
...
const NetworkTopologyMappingComponent: React.FC<NetworkTopologyMappingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic network topology visualization
        </Typography>
...
export default NetworkTopologyMappingComponent;