...
interface DensityAnalysisPlatformComponentProps {
...
const DensityAnalysisPlatformComponent: React.FC<DensityAnalysisPlatformComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic density analysis for threat concentration
        </Typography>
...
export default DensityAnalysisPlatformComponent;