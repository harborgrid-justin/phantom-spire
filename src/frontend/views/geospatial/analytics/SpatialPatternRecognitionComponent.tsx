...
interface SpatialPatternRecognitionComponentProps {
...
const SpatialPatternRecognitionComponent: React.FC<SpatialPatternRecognitionComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Machine learning-powered spatial pattern analysis
        </Typography>
...
export default SpatialPatternRecognitionComponent;