...
interface AttackSurfaceGeographyComponentProps {
...
const AttackSurfaceGeographyComponent: React.FC<AttackSurfaceGeographyComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic analysis of organizational attack surface
        </Typography>
...
export default AttackSurfaceGeographyComponent;