...
interface RansomwareGeographicIntelligenceComponentProps {
...
const RansomwareGeographicIntelligenceComponent: React.FC<RansomwareGeographicIntelligenceComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic intelligence on ransomware operations
        </Typography>
...
export default RansomwareGeographicIntelligenceComponent;