...
interface BotnetGeographicTrackingComponentProps {
...
const BotnetGeographicTrackingComponent: React.FC<BotnetGeographicTrackingComponentProps> = ({ onNavigate }) => {
      ...
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        <Box display="flex" alignItems="center" mb={2}>
          ...
          <Typography variant="h4" component="h1">
            🕷️ Botnet Geographic Tracking
          </Typography>
        </Box>
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic tracking and analysis of botnet activity
        </Typography>
...
export default BotnetGeographicTrackingComponent;