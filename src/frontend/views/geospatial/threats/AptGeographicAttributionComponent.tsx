...
interface AptGeographicAttributionComponentProps {
...
const AptGeographicAttributionComponent: React.FC<AptGeographicAttributionComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Advanced persistent threat geographic attribution
        </Typography>
...
export default AptGeographicAttributionComponent;