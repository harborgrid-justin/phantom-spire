...
interface DarkWebGeographicMappingComponentProps {
...
const DarkWebGeographicMappingComponent: React.FC<DarkWebGeographicMappingComponentProps> = ({ onNavigate }) => {
      ...
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        <Box display="flex" alignItems="center" mb={2}>
          ...
          <Typography variant="h4" component="h1">
            🕶️ Dark Web Geographic Mapping
          </Typography>
        </Box>
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic mapping of dark web threat activities
        </Typography>
...
export default DarkWebGeographicMappingComponent;