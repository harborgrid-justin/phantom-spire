...
interface PhishingCampaignGeographyComponentProps {
...
const PhishingCampaignGeographyComponent: React.FC<PhishingCampaignGeographyComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic analysis of phishing campaign origins
        </Typography>
...
export default PhishingCampaignGeographyComponent;