...
interface RegionalThreatAssessmentComponentProps {
...
const RegionalThreatAssessmentComponent: React.FC<RegionalThreatAssessmentComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Regional and country-specific threat intelligence
        </Typography>
...
export default RegionalThreatAssessmentComponent;