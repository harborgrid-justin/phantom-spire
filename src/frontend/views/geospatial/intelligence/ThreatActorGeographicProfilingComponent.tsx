...
interface ThreatActorGeographicProfilingComponentProps {
...
const ThreatActorGeographicProfilingComponent: React.FC<ThreatActorGeographicProfilingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic profiling and tracking of threat actors
        </Typography>
...
export default ThreatActorGeographicProfilingComponent;