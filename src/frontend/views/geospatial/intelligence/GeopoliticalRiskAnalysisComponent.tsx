...
interface GeopoliticalRiskAnalysisComponentProps {
...
const GeopoliticalRiskAnalysisComponent: React.FC<GeopoliticalRiskAnalysisComponentProps> = ({ onNavigate }) => {
...
export default GeopoliticalRiskAnalysisComponent;