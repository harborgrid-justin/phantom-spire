...
interface IpGeolocationTrackingComponentProps {
...
const IpGeolocationTrackingComponent: React.FC<IpGeolocationTrackingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Advanced IP address geolocation and threat analysis
        </Typography>
...
export default IpGeolocationTrackingComponent;