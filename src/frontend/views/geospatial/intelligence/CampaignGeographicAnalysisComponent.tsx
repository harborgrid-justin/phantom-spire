...
interface CampaignGeographicAnalysisComponentProps {
...
const CampaignGeographicAnalysisComponent: React.FC<CampaignGeographicAnalysisComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic spread analysis of threat campaigns
        </Typography>
...
export default CampaignGeographicAnalysisComponent;