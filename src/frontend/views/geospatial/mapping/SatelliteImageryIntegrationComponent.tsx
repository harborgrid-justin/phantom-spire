...
interface SatelliteImageryIntegrationComponentProps {
...
const SatelliteImageryIntegrationComponent: React.FC<SatelliteImageryIntegrationComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Real-time satellite imagery for threat assessment
        </Typography>
...
export default SatelliteImageryIntegrationComponent;