...
interface GeographicThreatVisualizationComponentProps {
...
const GeographicThreatVisualizationComponent: React.FC<GeographicThreatVisualizationComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Visual threat intelligence mapped to geographic locations
        </Typography>
...
export default GeographicThreatVisualizationComponent;