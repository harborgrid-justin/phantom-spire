...
interface AssetLocationMappingComponentProps {
...
const AssetLocationMappingComponent: React.FC<AssetLocationMappingComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Comprehensive asset location tracking and visualization
        </Typography>
...
export default AssetLocationMappingComponent;