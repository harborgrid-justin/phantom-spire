...
interface HeatMapAnalyticsComponentProps {
...
const HeatMapAnalyticsComponent: React.FC<HeatMapAnalyticsComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic heat map analysis for threat patterns
        </Typography>
...
export default HeatMapAnalyticsComponent;