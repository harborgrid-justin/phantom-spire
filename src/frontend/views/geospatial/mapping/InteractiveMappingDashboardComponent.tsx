...
interface InteractiveMappingDashboardComponentProps {
...
const InteractiveMappingDashboardComponent: React.FC<InteractiveMappingDashboardComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Real-time interactive maps with threat intelligence overlay
        </Typography>
...
export default InteractiveMappingDashboardComponent;