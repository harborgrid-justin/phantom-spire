...
interface IncidentGeographicCorrelationComponentProps {
...
const IncidentGeographicCorrelationComponent: React.FC<IncidentGeographicCorrelationComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic correlation analysis for security incidents
        </Typography>
...
export default IncidentGeographicCorrelationComponent;