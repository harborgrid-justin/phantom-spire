...
interface GeofencingManagementComponentProps {
...
const GeofencingManagementComponent: React.FC<GeofencingManagementComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Geographic boundary monitoring and alert system
        </Typography>
...
export default GeofencingManagementComponent;