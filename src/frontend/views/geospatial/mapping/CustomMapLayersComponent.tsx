...
interface CustomMapLayersComponentProps {
...
const CustomMapLayersComponent: React.FC<CustomMapLayersComponentProps> = ({ onNavigate }) => {
    ...
    <Box sx={{ p: 3 }}>
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Customizable map layers for specialized analysis
        </Typography>
...
export default CustomMapLayersComponent;