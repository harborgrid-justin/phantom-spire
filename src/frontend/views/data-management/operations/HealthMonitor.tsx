/**
 * 💚 Data Health Monitor
 * Monitor the health and status of all data systems
 */
...
export const HealthMonitor: React.FC = () => {
  ...
  const {
    ...
    hasErrors,
    refresh
  } = useServicePage('operations-health-monitor');
  ...
  useEffect(() => {
    addUIUXEvaluation({
      ...
      interactionPath: ['data-management', 'operations', 'health-monitor']
    });
  }, []);
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const response = await fetch('/api/v1/data-management/operations/health-monitor');
        if (!response.ok) {
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} lg={8}>
          <Paper elevation={2} sx={{ p: 3 }}>
            ...
            <Typography variant="body1" color="textSecondary" paragraph>
              This is the main content area for 💚 Data Health Monitor. 
