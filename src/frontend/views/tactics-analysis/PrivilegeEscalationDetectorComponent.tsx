...
interface PrivilegeEscalationDetectorProps {
...
const PrivilegeEscalationDetector: React.FC<PrivilegeEscalationDetectorProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default PrivilegeEscalationDetector;