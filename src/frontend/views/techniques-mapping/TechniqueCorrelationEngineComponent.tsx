...
interface TechniqueCorrelationEngineProps {
...
const TechniqueCorrelationEngine: React.FC<TechniqueCorrelationEngineProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default TechniqueCorrelationEngine;