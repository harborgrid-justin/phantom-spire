...
interface TechniquePrioritizationEngineProps {
...
const TechniquePrioritizationEngine: React.FC<TechniquePrioritizationEngineProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default TechniquePrioritizationEngine;