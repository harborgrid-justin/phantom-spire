...
interface TechniqueValidationSystemProps {
...
const TechniqueValidationSystem: React.FC<TechniqueValidationSystemProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default TechniqueValidationSystem;