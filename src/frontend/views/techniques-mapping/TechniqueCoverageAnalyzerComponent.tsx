...
interface TechniqueCoverageAnalyzerProps {
...
const TechniqueCoverageAnalyzer: React.FC<TechniqueCoverageAnalyzerProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default TechniqueCoverageAnalyzer;