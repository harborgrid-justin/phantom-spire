...
interface TechniqueEvolutionTrackerProps {
...
const TechniqueEvolutionTracker: React.FC<TechniqueEvolutionTrackerProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default TechniqueEvolutionTracker;