...
export const InformationSharingRouter: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/collaborative-analysis" element={<div>Collaborative Analysis Workbench - Coming Soon</div>} />
      <Route path="/shared-ioc-database" element={<div>Shared IOC Database - Coming Soon</div>} />
      <Route path="/shared-threat-hunting" element={<div>Shared Threat Hunting - Coming Soon</div>} />
      ...
      <Route path="/community-contributions" element={<div>Community Contributions - Coming Soon</div>} />
      <Route path="/osint-integration" element={<div>OSINT Integration - Coming Soon</div>} />
      ...
      <Route path="/compliance-center" element={<div>Regulatory Compliance Center - Coming Soon</div>} />
      <Route path="/audit-trail" element={<div>Sharing Audit Trail - Coming Soon</div>} />
