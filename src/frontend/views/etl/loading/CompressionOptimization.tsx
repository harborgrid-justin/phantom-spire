...
interface CompressionOptimizationData {
  id: string;
  name: string;
...
export const CompressionOptimization: React.FC = () => {
  const [data, setData] = useState<CompressionOptimizationData[]>([]);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: '1',
          name: 'Sample Compression Optimization',
          status: 'active',
