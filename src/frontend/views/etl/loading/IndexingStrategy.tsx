...
interface IndexingStrategyData {
  id: string;
  name: string;
...
export const IndexingStrategy: React.FC = () => {
  const [data, setData] = useState<IndexingStrategyData[]>([]);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setData([
        {
          id: '1',
          name: 'Sample Indexing Strategy Manager',
          status: 'active',
