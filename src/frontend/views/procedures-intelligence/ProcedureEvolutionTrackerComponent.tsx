...
interface ProcedureEvolutionTrackerProps {
...
const ProcedureEvolutionTracker: React.FC<ProcedureEvolutionTrackerProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureEvolutionTracker;