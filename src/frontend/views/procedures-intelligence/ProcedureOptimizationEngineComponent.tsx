...
interface ProcedureOptimizationEngineProps {
...
const ProcedureOptimizationEngine: React.FC<ProcedureOptimizationEngineProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureOptimizationEngine;