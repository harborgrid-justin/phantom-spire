...
interface ProcedureComplianceMonitorProps {
...
const ProcedureComplianceMonitor: React.FC<ProcedureComplianceMonitorProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureComplianceMonitor;