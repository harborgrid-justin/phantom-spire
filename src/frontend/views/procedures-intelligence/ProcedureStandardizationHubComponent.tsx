...
interface ProcedureStandardizationHubProps {
...
const ProcedureStandardizationHub: React.FC<ProcedureStandardizationHubProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureStandardizationHub;