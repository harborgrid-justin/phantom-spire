...
interface ProcedureAutomationWorkflowProps {
...
const ProcedureAutomationWorkflow: React.FC<ProcedureAutomationWorkflowProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureAutomationWorkflow;