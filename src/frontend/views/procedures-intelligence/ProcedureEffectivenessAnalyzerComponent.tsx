...
interface ProcedureEffectivenessAnalyzerProps {
...
const ProcedureEffectivenessAnalyzer: React.FC<ProcedureEffectivenessAnalyzerProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureEffectivenessAnalyzer;