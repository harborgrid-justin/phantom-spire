...
interface ProcedureValidationEngineProps {
...
const ProcedureValidationEngine: React.FC<ProcedureValidationEngineProps> = ({
  onDataUpdate,
  onRefresh,
  onExport,
  filters
...
export default ProcedureValidationEngine;