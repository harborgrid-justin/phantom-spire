...
interface ReportingDashboardComponentProps {
...
const ReportingDashboardComponent: React.FC<ReportingDashboardComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Reporting Dashboard',
          status: 'pending',
          type: 'windmill-feature',
          category: 'collaboration-workflow',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Reporting Dashboard
        </DialogTitle>
        <DialogContent>
