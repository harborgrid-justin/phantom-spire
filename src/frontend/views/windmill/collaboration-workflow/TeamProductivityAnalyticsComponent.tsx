...
interface TeamProductivityAnalyticsComponentProps {
...
const TeamProductivityAnalyticsComponent: React.FC<TeamProductivityAnalyticsComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Team Productivity Analytics',
          status: 'pending',
          type: 'windmill-feature',
          category: 'collaboration-workflow',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Team Productivity Analytics
        </DialogTitle>
        <DialogContent>
...
export default TeamProductivityAnalyticsComponent;
