...
interface OnboardingAutomationComponentProps {
...
const OnboardingAutomationComponent: React.FC<OnboardingAutomationComponentProps> = ({ onNavigate }) => {
      ...
      const mockData: WindmillData[] = [
        {
          ...
          metadata: {
            version: '2.1.0',
            tags: ['windmill', 'production', 'collaboration-workflow'],
            priority: 'high'
          }
        },
        {
          id: '2',
          name: 'Development Onboarding Automation',
          status: 'pending',
          type: 'windmill-feature',
          category: 'collaboration-workflow',
          ...
          metadata: {
            version: '1.5.0',
            tags: ['windmill', 'development', 'collaboration-workflow'],
            priority: 'medium'
          }
        }
      ];
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Onboarding Automation
        </DialogTitle>
        <DialogContent>
...
export default OnboardingAutomationComponent;
