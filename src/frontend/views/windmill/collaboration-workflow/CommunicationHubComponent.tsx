...
interface CommunicationHubComponentProps {
...
const CommunicationHubComponent: React.FC<CommunicationHubComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Communication Hub',
          status: 'pending',
          type: 'windmill-feature',
          category: 'collaboration-workflow',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Communication Hub
        </DialogTitle>
        <DialogContent>
...
export default CommunicationHubComponent;
