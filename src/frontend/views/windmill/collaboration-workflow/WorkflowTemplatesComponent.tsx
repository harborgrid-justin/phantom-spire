...
interface WorkflowTemplatesComponentProps {
...
const WorkflowTemplatesComponent: React.FC<WorkflowTemplatesComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Workflow Templates',
          status: 'pending',
          type: 'windmill-feature',
          category: 'collaboration-workflow',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Workflow Templates
        </DialogTitle>
        <DialogContent>
...
export default WorkflowTemplatesComponent;
