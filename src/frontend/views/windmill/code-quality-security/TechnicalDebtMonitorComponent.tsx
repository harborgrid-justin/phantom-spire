...
interface TechnicalDebtMonitorComponentProps {
...
const TechnicalDebtMonitorComponent: React.FC<TechnicalDebtMonitorComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Technical Debt Monitor',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Technical Debt Monitor
        </DialogTitle>
        <DialogContent>
...
export default TechnicalDebtMonitorComponent;
