...
interface CodeCoverageTrackerComponentProps {
...
const CodeCoverageTrackerComponent: React.FC<CodeCoverageTrackerComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Code Coverage Tracker',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Code Coverage Tracker
        </DialogTitle>
        <DialogContent>
...
export default CodeCoverageTrackerComponent;
