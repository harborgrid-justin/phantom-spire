...
interface CodeQualityAnalyzerComponentProps {
...
const CodeQualityAnalyzerComponent: React.FC<CodeQualityAnalyzerComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Code Quality Analyzer',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Code Quality Analyzer
        </DialogTitle>
        <DialogContent>
...
export default CodeQualityAnalyzerComponent;
