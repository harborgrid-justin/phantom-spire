...
interface LicenseComplianceManagerComponentProps {
...
const LicenseComplianceManagerComponent: React.FC<LicenseComplianceManagerComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development License Compliance Manager',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} License Compliance Manager
        </DialogTitle>
        <DialogContent>
...
export default LicenseComplianceManagerComponent;
