...
interface DocumentationGeneratorComponentProps {
...
const DocumentationGeneratorComponent: React.FC<DocumentationGeneratorComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Documentation Generator',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Documentation Generator
        </DialogTitle>
        <DialogContent>
...
export default DocumentationGeneratorComponent;
