...
interface SecurityScanningHubComponentProps {
...
const SecurityScanningHubComponent: React.FC<SecurityScanningHubComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Security Scanning Hub',
          status: 'pending',
          type: 'windmill-feature',
          category: 'code-quality-security',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Security Scanning Hub
        </DialogTitle>
        <DialogContent>
...
export default SecurityScanningHubComponent;
