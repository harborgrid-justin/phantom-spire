...
interface CodeMigrationAssistantComponentProps {
...
const CodeMigrationAssistantComponent: React.FC<CodeMigrationAssistantComponentProps> = ({ onNavigate }) => {
      ...
      const mockData: WindmillData[] = [
        {
          ...
          metadata: {
            version: '2.1.0',
            tags: ['windmill', 'production', 'repository-automation'],
            priority: 'high'
          }
        },
        {
          id: '2',
          name: 'Development Code Migration Assistant',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
          ...
          metadata: {
            version: '1.5.0',
            tags: ['windmill', 'development', 'repository-automation'],
            priority: 'medium'
          }
        }
      ];
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Code Migration Assistant
        </DialogTitle>
        <DialogContent>
...
export default CodeMigrationAssistantComponent;
