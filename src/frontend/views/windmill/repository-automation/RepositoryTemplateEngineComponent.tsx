...
interface RepositoryTemplateEngineComponentProps {
...
const RepositoryTemplateEngineComponent: React.FC<RepositoryTemplateEngineComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Repository Template Engine',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Repository Template Engine
        </DialogTitle>
        <DialogContent>
...
export default RepositoryTemplateEngineComponent;
