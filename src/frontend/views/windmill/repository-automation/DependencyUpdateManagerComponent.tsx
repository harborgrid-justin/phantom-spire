...
interface DependencyUpdateManagerComponentProps {
...
const DependencyUpdateManagerComponent: React.FC<DependencyUpdateManagerComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Dependency Update Manager',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Dependency Update Manager
        </DialogTitle>
        <DialogContent>
...
export default DependencyUpdateManagerComponent;
