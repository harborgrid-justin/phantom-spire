...
interface AutomatedBranchManagementComponentProps {
...
const AutomatedBranchManagementComponent: React.FC<AutomatedBranchManagementComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Automated Branch Management',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Automated Branch Management
        </DialogTitle>
        <DialogContent>
...
export default AutomatedBranchManagementComponent;
