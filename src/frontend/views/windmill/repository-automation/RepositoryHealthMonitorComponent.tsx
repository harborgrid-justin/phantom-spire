...
interface RepositoryHealthMonitorComponentProps {
...
const RepositoryHealthMonitorComponent: React.FC<RepositoryHealthMonitorComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Repository Health Monitor',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Repository Health Monitor
        </DialogTitle>
        <DialogContent>
...
export default RepositoryHealthMonitorComponent;
