...
interface IssueAutoClassificationComponentProps {
...
const IssueAutoClassificationComponent: React.FC<IssueAutoClassificationComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Issue Auto-Classification',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Issue Auto-Classification
        </DialogTitle>
        <DialogContent>
...
export default IssueAutoClassificationComponent;
