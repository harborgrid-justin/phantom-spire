...
interface PrReviewAutomationComponentProps {
...
const PrReviewAutomationComponent: React.FC<PrReviewAutomationComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development PR Review Automation',
          status: 'pending',
          type: 'windmill-feature',
          category: 'repository-automation',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} PR Review Automation
        </DialogTitle>
        <DialogContent>
...
export default PrReviewAutomationComponent;
