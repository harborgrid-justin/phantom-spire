...
interface PerformanceBenchmarkingComponentProps {
...
const PerformanceBenchmarkingComponent: React.FC<PerformanceBenchmarkingComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Performance Benchmarking',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Performance Benchmarking
        </DialogTitle>
        <DialogContent>
...
export default PerformanceBenchmarkingComponent;
