...
interface TestAutomationManagerComponentProps {
...
const TestAutomationManagerComponent: React.FC<TestAutomationManagerComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Test Automation Manager',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Test Automation Manager
        </DialogTitle>
        <DialogContent>
...
export default TestAutomationManagerComponent;
