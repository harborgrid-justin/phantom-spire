...
interface InfrastructureAsCodeComponentProps {
...
const InfrastructureAsCodeComponent: React.FC<InfrastructureAsCodeComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Infrastructure as Code',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Infrastructure as Code
        </DialogTitle>
        <DialogContent>
...
export default InfrastructureAsCodeComponent;
