...
interface RollbackManagementComponentProps {
...
const RollbackManagementComponent: React.FC<RollbackManagementComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Rollback Management',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Rollback Management
        </DialogTitle>
        <DialogContent>
...
export default RollbackManagementComponent;
