...
interface EnvironmentConfigurationComponentProps {
...
const EnvironmentConfigurationComponent: React.FC<EnvironmentConfigurationComponentProps> = ({ onNavigate }) => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Environment Configuration
        </DialogTitle>
        <DialogContent>
...
export default EnvironmentConfigurationComponent;
