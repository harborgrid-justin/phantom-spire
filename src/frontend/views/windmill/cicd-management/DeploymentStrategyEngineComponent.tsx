...
interface DeploymentStrategyEngineComponentProps {
...
const DeploymentStrategyEngineComponent: React.FC<DeploymentStrategyEngineComponentProps> = ({ onNavigate }) => {
      ...
      const mockData: WindmillData[] = [
        {
          ...
          metadata: {
            version: '2.1.0',
            tags: ['windmill', 'production', 'cicd-management'],
            priority: 'high'
          }
        },
        {
          id: '2',
          name: 'Development Deployment Strategy Engine',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
          ...
          metadata: {
            version: '1.5.0',
            tags: ['windmill', 'development', 'cicd-management'],
            priority: 'medium'
          }
        }
      ];
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Deployment Strategy Engine
        </DialogTitle>
        <DialogContent>
...
export default DeploymentStrategyEngineComponent;
