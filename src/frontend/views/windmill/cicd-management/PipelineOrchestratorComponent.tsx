...
interface PipelineOrchestratorComponentProps {
...
const PipelineOrchestratorComponent: React.FC<PipelineOrchestratorComponentProps> = ({ onNavigate }) => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Pipeline Orchestrator
        </DialogTitle>
        <DialogContent>
...
export default PipelineOrchestratorComponent;
