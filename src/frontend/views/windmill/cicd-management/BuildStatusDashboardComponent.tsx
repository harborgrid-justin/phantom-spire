...
interface BuildStatusDashboardComponentProps {
...
const BuildStatusDashboardComponent: React.FC<BuildStatusDashboardComponentProps> = ({ onNavigate }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: WindmillData[] = [
        ...
        {
          id: '2',
          name: 'Development Build Status Dashboard',
          status: 'pending',
          type: 'windmill-feature',
          category: 'cicd-management',
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selectedItem ? 'Edit' : 'Create'} Build Status Dashboard
        </DialogTitle>
        <DialogContent>
...
export default BuildStatusDashboardComponent;
