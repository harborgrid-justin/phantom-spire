/**
 * Case Template Management Controller
 * Case template creation and customization
 */
...
export class CaseTemplateManagementController {
  /**
   * Get all case template management entries
   */
  getAll = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    const mockData = [
      {
        id: '1',
        title: 'Sample Case Template Management Entry',
      ...
      {
        id: '2',
        title: 'Another Case Template Management Entry',
        description: 'Additional sample data for case template creation and customization',
        status: 'pending',
  ...
  /**
   * Create a new case template management entry
   */
  create = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    res.status(201).json({
      success: true,
      data: newEntry,
      message: 'Case Template Management entry created successfully',
      timestamp: new Date().toISOString()
    });
  });

  /**
   * Get a specific case template management entry
   */
  getById = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    const mockEntry = {
      id,
      title: `Case Template Management Entry ${id}`,
      description: 'Case template creation and customization',
      status: 'active',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
  ...
  /**
   * Update a case template management entry
   */
  update = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    res.json({
      success: true,
      data: updatedEntry,
      message: 'Case Template Management entry updated successfully',
      timestamp: new Date().toISOString()
    });
  });

  /**
   * Delete a case template management entry
   */
  delete = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    res.json({
      success: true,
      message: 'Case Template Management entry deleted successfully',
      deletedId: id,
      timestamp: new Date().toISOString()
    });
  });
  ...
  /**
   * Get analytics for case template management
   */
