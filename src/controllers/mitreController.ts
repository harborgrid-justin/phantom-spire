 ...
 */
export const syncMitreData = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    ...
    try {
      ...
      logger.info(
        `MITRE ATT&CK data sync completed by user ${req.user.id}`,
        results
      );
 ...
 */
export const getMitreStats = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    if (!req.user) {
 ...
 */
export const getTactics = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
 ...
 */
export const getTactic = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
 ...
 */
export const getTechniques = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = Math.min(parseInt(req.query.limit as string) || 50, 100);
    const skip = (page - 1) * limit;
 ...
 */
export const getTechnique = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const { mitreId } = req.params;
 ...
 */
export const getSoftware = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = Math.min(parseInt(req.query.limit as string) || 50, 100);
    const skip = (page - 1) * limit;
 ...
 */
export const getSoftwareById = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const { mitreId } = req.params;
 ...
 */
export const getMitigations = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = Math.min(parseInt(req.query.limit as string) || 50, 100);
    const skip = (page - 1) * limit;
 ...
 */
export const getMitigation = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const { mitreId } = req.params;
 ...
 */
export const getDataSources = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const page = parseInt(req.query.page as string) || 1;
    const limit = Math.min(parseInt(req.query.limit as string) || 50, 100);
    const skip = (page - 1) * limit;
 ...
 */
export const getDataSource = asyncHandler(
  async (req: AuthRequest, res: Response): Promise<void> => {
    const { mitreId } = req.params;
