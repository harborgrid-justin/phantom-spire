  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const connectionResult =
        await databaseHealthService.checkConnection(database);
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.log(
        `Creating admin user: ${username} for organization: ${organization}`
      );
