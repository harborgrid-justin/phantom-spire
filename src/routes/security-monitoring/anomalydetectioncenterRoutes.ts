...
import { AnomalyDetectionCenterBusinessLogic } from '../services/business-logic/modules/security-monitoring/AnomalyDetectionCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new AnomalyDetectionCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/anomalydetectioncenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/anomalydetectioncenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/anomalydetectioncenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/anomalydetectioncenter/bulk:
 *   put:
