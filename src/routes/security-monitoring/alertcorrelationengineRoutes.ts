...
import { AlertCorrelationEngineBusinessLogic } from '../services/business-logic/modules/security-monitoring/AlertCorrelationEngineBusinessLogic.js';
...
const router = Router();
const businessLogic = new AlertCorrelationEngineBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/alertcorrelationengine:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/alertcorrelationengine/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/alertcorrelationengine/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/alertcorrelationengine/bulk:
 *   put:
