...
import { BaselineMonitoringSystemBusinessLogic } from '../services/business-logic/modules/security-monitoring/BaselineMonitoringSystemBusinessLogic.js';
...
const router = Router();
const businessLogic = new BaselineMonitoringSystemBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/baselinemonitoringsystem:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/baselinemonitoringsystem/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/baselinemonitoringsystem/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/baselinemonitoringsystem/bulk:
 *   put:
