...
import { SIEMIntegrationHubBusinessLogic } from '../services/business-logic/modules/security-monitoring/SIEMIntegrationHubBusinessLogic.js';
...
const router = Router();
const businessLogic = new SIEMIntegrationHubBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/siemintegrationhub:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/siemintegrationhub/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/siemintegrationhub/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/siemintegrationhub/bulk:
 *   put:
