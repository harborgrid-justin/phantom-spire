...
import { LogAnalysisWorkbenchBusinessLogic } from '../services/business-logic/modules/security-monitoring/LogAnalysisWorkbenchBusinessLogic.js';
...
const router = Router();
const businessLogic = new LogAnalysisWorkbenchBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/loganalysisworkbench:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/loganalysisworkbench/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/loganalysisworkbench/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/loganalysisworkbench/bulk:
 *   put:
