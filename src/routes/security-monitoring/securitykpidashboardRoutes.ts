...
import { SecurityKPIDashboardBusinessLogic } from '../services/business-logic/modules/security-monitoring/SecurityKPIDashboardBusinessLogic.js';
...
const router = Router();
const businessLogic = new SecurityKPIDashboardBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/securitykpidashboard:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/securitykpidashboard/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/securitykpidashboard/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/securitykpidashboard/bulk:
 *   put:
