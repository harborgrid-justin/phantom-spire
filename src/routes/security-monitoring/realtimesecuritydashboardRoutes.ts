...
import { RealTimeSecurityDashboardBusinessLogic } from '../services/business-logic/modules/security-monitoring/RealTimeSecurityDashboardBusinessLogic.js';
...
const router = Router();
const businessLogic = new RealTimeSecurityDashboardBusinessLogic();

/**
 * @swagger
 * /api/v1/security-monitoring/realtimesecuritydashboard:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/realtimesecuritydashboard/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/realtimesecuritydashboard/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/security-monitoring/realtimesecuritydashboard/bulk:
 *   put:
