...
router.get(
  '/evidence/collection',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getEvidenceCollection
);
router.get(
  '/evidence/preservation',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getEvidencePreservation
);
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve custody records',
      });
    }
  }
);
...
router.get(
  '/evidence/imaging',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getForensicImaging
);
router.get(
  '/evidence/validation',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getEvidenceValidation
);
router.get(
  '/evidence/correlation',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getEvidenceCorrelation
);
router.get(
  '/evidence/legal-hold',
  authorizeRole(['analyst', 'investigator', 'admin', 'legal']),
  DigitalForensicsController.getLegalHoldManagement
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(500)
        .json({ success: false, message: 'Failed to retrieve export data' });
    }
  }
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(500)
        .json({ success: false, message: 'Failed to retrieve search data' });
    }
  }
);
...
router.get(
  '/investigation/cases',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getInvestigationCases
);
router.get(
  '/investigation/examination',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getForensicExamination
);
router.get(
  '/investigation/memory',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getMemoryForensics
);
router.get(
  '/investigation/network',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getNetworkForensics
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve mobile forensics data',
      });
    }
  }
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve cloud forensics data',
      });
    }
  }
);
...
router.get(
  '/specialized/email',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getEmailForensics
);
router.get(
  '/specialized/database',
  authorizeRole(['analyst', 'investigator', 'admin']),
  DigitalForensicsController.getDatabaseForensics
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve IoT forensics data',
      });
    }
  }
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve cryptocurrency forensics data',
      });
    }
  }
);
...
router.get(
  ...
  authorizeRole(['analyst', 'investigator', 'admin', 'legal']),
  DigitalForensicsController.getLegalRequirements
);
router.get(
  '/compliance/regulatory',
  authorizeRole(['analyst', 'investigator', 'admin', 'legal']),
  DigitalForensicsController.getRegulatoryCompliance
);

router.get(
  '/compliance/court-admissibility',
  authorizeRole(['analyst', 'investigator', 'admin', 'legal']),
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve court admissibility data',
      });
    }
  }
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve expert witness data',
      });
    }
  }
);
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      logger.error(
        `Forensics ${req.params.category}/${req.params.service} error:`,
        error
      );
      res.status(500).json({
        success: false,
