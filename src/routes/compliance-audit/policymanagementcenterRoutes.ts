...
import { PolicyManagementCenterBusinessLogic } from '../services/business-logic/modules/compliance-audit/PolicyManagementCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new PolicyManagementCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/policymanagementcenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/policymanagementcenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/policymanagementcenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/policymanagementcenter/bulk:
 *   put:
