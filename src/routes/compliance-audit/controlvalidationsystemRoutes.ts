...
import { ControlValidationSystemBusinessLogic } from '../services/business-logic/modules/compliance-audit/ControlValidationSystemBusinessLogic.js';
...
const router = Router();
const businessLogic = new ControlValidationSystemBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/controlvalidationsystem:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/controlvalidationsystem/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/controlvalidationsystem/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/controlvalidationsystem/bulk:
 *   put:
