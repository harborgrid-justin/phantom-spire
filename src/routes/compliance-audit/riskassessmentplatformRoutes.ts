...
import { RiskAssessmentPlatformBusinessLogic } from '../services/business-logic/modules/compliance-audit/RiskAssessmentPlatformBusinessLogic.js';
...
const router = Router();
const businessLogic = new RiskAssessmentPlatformBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/riskassessmentplatform:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/riskassessmentplatform/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/riskassessmentplatform/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/riskassessmentplatform/bulk:
 *   put:
