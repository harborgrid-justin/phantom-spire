...
import { RemediationPlanningWorkbenchBusinessLogic } from '../services/business-logic/modules/compliance-audit/RemediationPlanningWorkbenchBusinessLogic.js';
...
const router = Router();
const businessLogic = new RemediationPlanningWorkbenchBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/remediationplanningworkbench:
 *   get:
 *     summary: List compliance audit items
 ...
 *     responses:
 *       200:
 *         description: List of compliance audit items
 *       401:
 ...
 * /api/v1/compliance-audit/remediationplanningworkbench:
 *   post:
 *     summary: Create new compliance audit item
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
/**
 * @swagger
 * /api/v1/compliance-audit/remediationplanningworkbench/{id}:
 *   get:
 *     summary: Get compliance audit item by ID
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/compliance-audit/remediationplanningworkbench/{id}:
 *   put:
 *     summary: Update compliance audit item
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/compliance-audit/remediationplanningworkbench/{id}:
 *   delete:
 *     summary: Delete compliance audit item
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/v1/compliance-audit/remediationplanningworkbench/analytics:
 *   get:
 *     summary: Get compliance audit analytics
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     responses:
...
/**
 * @swagger
 * /api/v1/compliance-audit/remediationplanningworkbench/bulk:
 *   put:
 *     summary: Bulk update compliance audit items
 *     tags: [compliance-audit]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
