...
import { FrameworkMappingCenterBusinessLogic } from '../services/business-logic/modules/compliance-audit/FrameworkMappingCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new FrameworkMappingCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/frameworkmappingcenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/frameworkmappingcenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/frameworkmappingcenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/frameworkmappingcenter/bulk:
 *   put:
