...
import { ComplianceReportingHubBusinessLogic } from '../services/business-logic/modules/compliance-audit/ComplianceReportingHubBusinessLogic.js';
...
const router = Router();
const businessLogic = new ComplianceReportingHubBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/compliancereportinghub:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/compliancereportinghub/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/compliancereportinghub/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/compliancereportinghub/bulk:
 *   put:
