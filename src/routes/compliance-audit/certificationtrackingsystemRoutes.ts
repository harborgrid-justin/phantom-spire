...
import { CertificationTrackingSystemBusinessLogic } from '../services/business-logic/modules/compliance-audit/CertificationTrackingSystemBusinessLogic.js';
...
const router = Router();
const businessLogic = new CertificationTrackingSystemBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/certificationtrackingsystem:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/certificationtrackingsystem/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/certificationtrackingsystem/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/certificationtrackingsystem/bulk:
 *   put:
