...
import { AuditTrailAnalyzerBusinessLogic } from '../services/business-logic/modules/compliance-audit/AuditTrailAnalyzerBusinessLogic.js';
...
const router = Router();
const businessLogic = new AuditTrailAnalyzerBusinessLogic();

/**
 * @swagger
 * /api/v1/compliance-audit/audittrailanalyzer:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/audittrailanalyzer/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/audittrailanalyzer/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/compliance-audit/audittrailanalyzer/bulk:
 *   put:
