...
import { CloudForensicsAnalyzerBusinessLogic } from '../services/business-logic/modules/digital-forensics/CloudForensicsAnalyzerBusinessLogic.js';
...
const router = Router();
const businessLogic = new CloudForensicsAnalyzerBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/cloudforensicsanalyzer:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/cloudforensicsanalyzer/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/cloudforensicsanalyzer/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/cloudforensicsanalyzer/bulk:
 *   put:
