...
import { NetworkForensicsCenterBusinessLogic } from '../services/business-logic/modules/digital-forensics/NetworkForensicsCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new NetworkForensicsCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/networkforensicscenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/networkforensicscenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/networkforensicscenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/networkforensicscenter/bulk:
 *   put:
