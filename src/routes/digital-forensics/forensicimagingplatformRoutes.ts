...
import { ForensicImagingPlatformBusinessLogic } from '../services/business-logic/modules/digital-forensics/ForensicImagingPlatformBusinessLogic.js';
...
const router = Router();
const businessLogic = new ForensicImagingPlatformBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/forensicimagingplatform:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/forensicimagingplatform/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/forensicimagingplatform/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/forensicimagingplatform/bulk:
 *   put:
