...
import { EvidenceAcquisitionWorkflowBusinessLogic } from '../services/business-logic/modules/digital-forensics/EvidenceAcquisitionWorkflowBusinessLogic.js';
...
const router = Router();
const businessLogic = new EvidenceAcquisitionWorkflowBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/evidenceacquisitionworkflow:
 *   get:
 *     summary: List digital forensics items
 ...
 *     responses:
 *       200:
 *         description: List of digital forensics items
 *       401:
 ...
 * /api/v1/digital-forensics/evidenceacquisitionworkflow:
 *   post:
 *     summary: Create new digital forensics item
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
/**
 * @swagger
 * /api/v1/digital-forensics/evidenceacquisitionworkflow/{id}:
 *   get:
 *     summary: Get digital forensics item by ID
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/digital-forensics/evidenceacquisitionworkflow/{id}:
 *   put:
 *     summary: Update digital forensics item
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/digital-forensics/evidenceacquisitionworkflow/{id}:
 *   delete:
 *     summary: Delete digital forensics item
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/v1/digital-forensics/evidenceacquisitionworkflow/analytics:
 *   get:
 *     summary: Get digital forensics analytics
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     responses:
...
/**
 * @swagger
 * /api/v1/digital-forensics/evidenceacquisitionworkflow/bulk:
 *   put:
 *     summary: Bulk update digital forensics items
 *     tags: [digital-forensics]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
