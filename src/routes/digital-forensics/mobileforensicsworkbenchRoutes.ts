...
import { MobileForensicsWorkbenchBusinessLogic } from '../services/business-logic/modules/digital-forensics/MobileForensicsWorkbenchBusinessLogic.js';
...
const router = Router();
const businessLogic = new MobileForensicsWorkbenchBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/mobileforensicsworkbench:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/mobileforensicsworkbench/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/mobileforensicsworkbench/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/mobileforensicsworkbench/bulk:
 *   put:
