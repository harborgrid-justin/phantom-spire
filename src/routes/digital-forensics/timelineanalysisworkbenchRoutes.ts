...
import { TimelineAnalysisWorkbenchBusinessLogic } from '../services/business-logic/modules/digital-forensics/TimelineAnalysisWorkbenchBusinessLogic.js';
...
const router = Router();
const businessLogic = new TimelineAnalysisWorkbenchBusinessLogic();

/**
 * @swagger
 * /api/v1/digital-forensics/timelineanalysisworkbench:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/timelineanalysisworkbench/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/timelineanalysisworkbench/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/digital-forensics/timelineanalysisworkbench/bulk:
 *   put:
