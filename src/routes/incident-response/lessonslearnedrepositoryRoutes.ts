...
import { LessonsLearnedRepositoryBusinessLogic } from '../services/business-logic/modules/incident-response/LessonsLearnedRepositoryBusinessLogic.js';
...
const router = Router();
const businessLogic = new LessonsLearnedRepositoryBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/lessonslearnedrepository:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/lessonslearnedrepository/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/lessonslearnedrepository/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/lessonslearnedrepository/bulk:
 *   put:
