...
import { RecoveryPlanningCenterBusinessLogic } from '../services/business-logic/modules/incident-response/RecoveryPlanningCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new RecoveryPlanningCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/recoveryplanningcenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/recoveryplanningcenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/recoveryplanningcenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/recoveryplanningcenter/bulk:
 *   put:
