...
import { EvidenceCollectionManagerBusinessLogic } from '../services/business-logic/modules/incident-response/EvidenceCollectionManagerBusinessLogic.js';
...
const router = Router();
const businessLogic = new EvidenceCollectionManagerBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/evidencecollectionmanager:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/evidencecollectionmanager/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/evidencecollectionmanager/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/evidencecollectionmanager/bulk:
 *   put:
