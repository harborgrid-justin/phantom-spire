...
import { ForensicTimelineAnalyzerBusinessLogic } from '../services/business-logic/modules/incident-response/ForensicTimelineAnalyzerBusinessLogic.js';
...
const router = Router();
const businessLogic = new ForensicTimelineAnalyzerBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/forensictimelineanalyzer:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/forensictimelineanalyzer/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/forensictimelineanalyzer/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/forensictimelineanalyzer/bulk:
 *   put:
