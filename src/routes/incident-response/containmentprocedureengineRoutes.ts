...
import { ContainmentProcedureEngineBusinessLogic } from '../services/business-logic/modules/incident-response/ContainmentProcedureEngineBusinessLogic.js';
...
const router = Router();
const businessLogic = new ContainmentProcedureEngineBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/containmentprocedureengine:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/containmentprocedureengine/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/containmentprocedureengine/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/containmentprocedureengine/bulk:
 *   put:
