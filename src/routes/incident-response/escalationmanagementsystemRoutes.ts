...
import { EscalationManagementSystemBusinessLogic } from '../services/business-logic/modules/incident-response/EscalationManagementSystemBusinessLogic.js';
...
/**
 * @swagger
 * /api/v1/incident-response/escalationmanagementsystem:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/escalationmanagementsystem/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/escalationmanagementsystem/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/escalationmanagementsystem/bulk:
 *   put:
