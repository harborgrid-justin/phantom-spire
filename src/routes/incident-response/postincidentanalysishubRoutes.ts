...
import { PostIncidentAnalysisHubBusinessLogic } from '../services/business-logic/modules/incident-response/PostIncidentAnalysisHubBusinessLogic.js';
...
const router = Router();
const businessLogic = new PostIncidentAnalysisHubBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/postincidentanalysishub:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/postincidentanalysishub/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/postincidentanalysishub/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/postincidentanalysishub/bulk:
 *   put:
