...
import { ComplianceReportGeneratorBusinessLogic } from '../services/business-logic/modules/incident-response/ComplianceReportGeneratorBusinessLogic.js';
...
const router = Router();
const businessLogic = new ComplianceReportGeneratorBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/compliancereportgenerator:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/compliancereportgenerator/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/compliancereportgenerator/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/compliancereportgenerator/bulk:
 *   put:
