...
import { AutomatedResponseWorkflowBusinessLogic } from '../services/business-logic/modules/incident-response/AutomatedResponseWorkflowBusinessLogic.js';
...
const router = Router();
const businessLogic = new AutomatedResponseWorkflowBusinessLogic();

/**
 * @swagger
 * /api/v1/incident-response/automatedresponseworkflow:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/automatedresponseworkflow/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/automatedresponseworkflow/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/incident-response/automatedresponseworkflow/bulk:
 *   put:
