...
import { HuntingMetricsDashboardBusinessLogic } from '../services/business-logic/modules/threat-hunting/HuntingMetricsDashboardBusinessLogic.js';
...
const router = Router();
const businessLogic = new HuntingMetricsDashboardBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/huntingmetricsdashboard:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/huntingmetricsdashboard/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/huntingmetricsdashboard/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/huntingmetricsdashboard/bulk:
 *   put:
