...
import { TTaPsAnalysisPlatformBusinessLogic } from '../services/business-logic/modules/threat-hunting/TTaPsAnalysisPlatformBusinessLogic.js';
...
const router = Router();
const businessLogic = new TTaPsAnalysisPlatformBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/ttapsanalysisplatform:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ttapsanalysisplatform/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ttapsanalysisplatform/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ttapsanalysisplatform/bulk:
 *   put:
