...
import { ThreatActorProfilingCenterBusinessLogic } from '../services/business-logic/modules/threat-hunting/ThreatActorProfilingCenterBusinessLogic.js';
...
const router = Router();
const businessLogic = new ThreatActorProfilingCenterBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/threatactorprofilingcenter:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatactorprofilingcenter/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatactorprofilingcenter/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatactorprofilingcenter/bulk:
 *   put:
