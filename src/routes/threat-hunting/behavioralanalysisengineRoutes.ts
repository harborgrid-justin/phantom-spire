...
import { BehavioralAnalysisEngineBusinessLogic } from '../services/business-logic/modules/threat-hunting/BehavioralAnalysisEngineBusinessLogic.js';
...
const router = Router();
const businessLogic = new BehavioralAnalysisEngineBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/behavioralanalysisengine:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/behavioralanalysisengine/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/behavioralanalysisengine/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/behavioralanalysisengine/bulk:
 *   put:
