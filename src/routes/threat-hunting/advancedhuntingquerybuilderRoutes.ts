...
import { AdvancedHuntingQueryBuilderBusinessLogic } from '../services/business-logic/modules/threat-hunting/AdvancedHuntingQueryBuilderBusinessLogic.js';
...
const router = Router();
const businessLogic = new AdvancedHuntingQueryBuilderBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/advancedhuntingquerybuilder:
 *   get:
 *     summary: List threat hunting items
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: List of threat hunting items
 *       401:
 ...
 * /api/v1/threat-hunting/advancedhuntingquerybuilder:
 *   post:
 *     summary: Create new threat hunting item
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
/**
 * @swagger
 * /api/v1/threat-hunting/advancedhuntingquerybuilder/{id}:
 *   get:
 *     summary: Get threat hunting item by ID
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/threat-hunting/advancedhuntingquerybuilder/{id}:
 *   put:
 *     summary: Update threat hunting item
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /api/v1/threat-hunting/advancedhuntingquerybuilder/{id}:
 *   delete:
 *     summary: Delete threat hunting item
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/v1/threat-hunting/advancedhuntingquerybuilder/analytics:
 *   get:
 *     summary: Get threat hunting analytics
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     responses:
...
/**
 * @swagger
 * /api/v1/threat-hunting/advancedhuntingquerybuilder/bulk:
 *   put:
 *     summary: Bulk update threat hunting items
 *     tags: [threat-hunting]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
