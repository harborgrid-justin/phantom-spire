...
import { ThreatLandscapeMapperBusinessLogic } from '../services/business-logic/modules/threat-hunting/ThreatLandscapeMapperBusinessLogic.js';
...
const router = Router();
const businessLogic = new ThreatLandscapeMapperBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/threatlandscapemapper:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatlandscapemapper/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatlandscapemapper/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/threatlandscapemapper/bulk:
 *   put:
