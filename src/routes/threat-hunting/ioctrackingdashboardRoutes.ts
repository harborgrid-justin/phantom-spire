...
import { IOCTrackingDashboardBusinessLogic } from '../services/business-logic/modules/threat-hunting/IOCTrackingDashboardBusinessLogic.js';
...
const router = Router();
const businessLogic = new IOCTrackingDashboardBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/ioctrackingdashboard:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ioctrackingdashboard/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ioctrackingdashboard/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/ioctrackingdashboard/bulk:
 *   put:
