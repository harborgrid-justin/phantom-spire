...
import { CampaignTrackingSystemBusinessLogic } from '../services/business-logic/modules/threat-hunting/CampaignTrackingSystemBusinessLogic.js';
...
const router = Router();
const businessLogic = new CampaignTrackingSystemBusinessLogic();

/**
 * @swagger
 * /api/v1/threat-hunting/campaigntrackingsystem:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/campaigntrackingsystem/{id}:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/campaigntrackingsystem/analytics:
 *   get:
...
/**
 * @swagger
 * /api/v1/threat-hunting/campaigntrackingsystem/bulk:
 *   put:
