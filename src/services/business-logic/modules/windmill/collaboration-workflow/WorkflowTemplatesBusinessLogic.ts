/**
 * Workflow Templates Business Logic Service
 * Reusable workflow templates and process automation
 */

export class WorkflowTemplatesBusinessLogic {
  private readonly serviceName = 'workflow-templates-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      {
        name: 'validation',
        description: 'Validate workflow-templates data integrity',
        priority: 1,
      ...
      {
        name: 'enrichment',
        description: 'Enrich workflow-templates with contextual data',
        priority: 2,
