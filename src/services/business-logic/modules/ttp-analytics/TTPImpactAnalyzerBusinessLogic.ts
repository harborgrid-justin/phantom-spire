...
const logger = new Logger('TTPImpactAnalyzerBusinessLogic');

interface TTPImpactAnalyzerAnalytics {
  totalCount: number;
...
export class TTPImpactAnalyzerBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPImpactAnalyzerAnalytics> {
    try {
