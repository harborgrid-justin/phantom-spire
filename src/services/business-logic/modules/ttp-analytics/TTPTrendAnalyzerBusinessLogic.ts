...
const logger = new Logger('TTPTrendAnalyzerBusinessLogic');

interface TTPTrendAnalyzerAnalytics {
  totalCount: number;
...
export class TTPTrendAnalyzerBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPTrendAnalyzerAnalytics> {
    try {
