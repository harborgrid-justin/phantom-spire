...
const logger = new Logger('TTPRiskAssessmentBusinessLogic');

interface TTPRiskAssessmentAnalytics {
  totalCount: number;
...
export class TTPRiskAssessmentBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPRiskAssessmentAnalytics> {
    try {
