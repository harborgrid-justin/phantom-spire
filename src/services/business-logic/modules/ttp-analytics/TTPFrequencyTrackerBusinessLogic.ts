...
const logger = new Logger('TTPFrequencyTrackerBusinessLogic');

interface TTPFrequencyTrackerAnalytics {
  totalCount: number;
...
export class TTPFrequencyTrackerBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPFrequencyTrackerAnalytics> {
    try {
