...
export class ComplianceMonitoringDashboardBusinessLogic {
  private readonly serviceName =
    'compliance-monitoring-dashboard-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      ...
      },
      {
        name: 'enrichment',
        description:
          'Enrich compliance monitoring dashboard with contextual data',
        priority: 2,
      ...
      },
      {
        name: 'compliance',
        description:
          'Apply compliance rules to compliance monitoring dashboard',
        priority: 3,
      ...
      },
      {
        name: 'notification',
        description:
          'Process notifications for compliance monitoring dashboard',
        priority: 4,
