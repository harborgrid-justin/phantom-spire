...
export class RegulatoryComplianceDashboardBusinessLogic {
  private readonly serviceName =
    'regulatory-compliance-dashboard-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      ...
      },
      {
        name: 'enrichment',
        description:
          'Enrich regulatory compliance dashboard with contextual data',
        priority: 2,
      ...
      },
      {
        name: 'compliance',
        description:
          'Apply compliance rules to regulatory compliance dashboard',
        priority: 3,
      ...
      },
      {
        name: 'notification',
        description:
          'Process notifications for regulatory compliance dashboard',
        priority: 4,
