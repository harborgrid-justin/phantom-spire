...
export class FinancialPerformanceAnalyticsBusinessLogic {
  private readonly serviceName =
    'financial-performance-analytics-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      ...
      },
      {
        name: 'enrichment',
        description:
          'Enrich financial performance analytics with contextual data',
        priority: 2,
      ...
      },
      {
        name: 'compliance',
        description:
          'Apply compliance rules to financial performance analytics',
        priority: 3,
      ...
      },
      {
        name: 'notification',
        description:
          'Process notifications for financial performance analytics',
        priority: 4,
