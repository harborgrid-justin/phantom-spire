...
export class WorkflowOptimizationDashboardBusinessLogic {
  private readonly serviceName =
    'workflow-optimization-dashboard-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      ...
      },
      {
        name: 'enrichment',
        description:
          'Enrich workflow optimization dashboard with contextual data',
        priority: 2,
      ...
      },
      {
        name: 'compliance',
        description:
          'Apply compliance rules to workflow optimization dashboard',
        priority: 3,
      ...
      },
      {
        name: 'notification',
        description:
          'Process notifications for workflow optimization dashboard',
        priority: 4,
