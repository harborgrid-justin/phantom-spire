/**
 * Project Feasibility Analyzer Business Logic
 */
...
export class ProjectFeasibilityAnalyzerBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('projectFeasibilityAnalyzer', 'Project Feasibility Analyzer', 'planning');
  }
  ...
  async processWorkflow(request: BusinessLogicRequest): Promise<BusinessLogicResponse> {
    try {
      ...
      return {
        ...
        metadata: {
          category: 'planning',
          module: 'project-feasibility-analyzer'
        }
      };
    } catch (error) {
      return {
