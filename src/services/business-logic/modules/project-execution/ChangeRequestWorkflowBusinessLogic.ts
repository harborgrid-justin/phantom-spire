/**
 * Change Request Workflow Business Logic
 */
...
export class ChangeRequestWorkflowBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('changeRequestWorkflow', 'Change Request Workflow', 'risk-quality');
  }
    ...
    try {
      ...
      return {
        ...
        metadata: {
          ...
          module: 'change-request-workflow'
        }
      };
    } catch (error) {
      return {
