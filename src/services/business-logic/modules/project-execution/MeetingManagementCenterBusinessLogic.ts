/**
 * Meeting Management Center Business Logic
 */
...
export class MeetingManagementCenterBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('meetingManagementCenter', 'Meeting Management Center', 'communication');
  }
    ...
    try {
      ...
      return {
        ...
        metadata: {
          ...
          module: 'meeting-management-center'
        }
      };
    } catch (error) {
      return {
