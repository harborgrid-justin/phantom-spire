/**
 * Resource Capacity Planner Business Logic
 */
...
export class ResourceCapacityPlannerBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('resourceCapacityPlanner', 'Resource Capacity Planner', 'resources');
  }
  ...
  async processWorkflow(request: BusinessLogicRequest): Promise<BusinessLogicResponse> {
    try {
      ...
      return {
        ...
        metadata: {
          category: 'resources',
          module: 'resource-capacity-planner'
        }
      };
    } catch (error) {
      return {
