/**
 * Cost Tracking Dashboard Business Logic
 */
...
export class CostTrackingDashboardBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('costTrackingDashboard', 'Cost Tracking Dashboard', 'budget');
  }
  ...
  async processWorkflow(request: BusinessLogicRequest): Promise<BusinessLogicResponse> {
    try {
      ...
      return {
        ...
        metadata: {
          category: 'budget',
          module: 'cost-tracking-dashboard'
        }
      };
    } catch (error) {
      return {
