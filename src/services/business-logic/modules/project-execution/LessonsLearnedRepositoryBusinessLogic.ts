/**
 * Lessons Learned Repository Business Logic
 */
...
export class LessonsLearnedRepositoryBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('lessonsLearnedRepository', 'Lessons Learned Repository', 'risk-quality');
  }
    ...
    try {
      ...
      return {
        ...
        metadata: {
          ...
          module: 'lessons-learned-repository'
        }
      };
    } catch (error) {
      return {
