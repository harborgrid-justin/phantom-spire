/**
 * Quality Assurance Framework Business Logic
 */
...
export class QualityAssuranceFrameworkBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('qualityAssuranceFramework', 'Quality Assurance Framework', 'risk-quality');
  }
    ...
    try {
      ...
      return {
        ...
        metadata: {
          ...
          module: 'quality-assurance-framework'
        }
      };
    } catch (error) {
      return {
