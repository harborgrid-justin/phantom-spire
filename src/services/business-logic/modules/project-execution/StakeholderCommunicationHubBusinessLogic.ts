/**
 * Stakeholder Communication Hub Business Logic
 */
...
export class StakeholderCommunicationHubBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('stakeholderCommunicationHub', 'Stakeholder Communication Hub', 'communication');
  }
    ...
    try {
      ...
      return {
        ...
        metadata: {
          ...
          module: 'stakeholder-communication-hub'
        }
      };
    } catch (error) {
      return {
