/**
 * Milestone Tracking Center Business Logic
 */
...
export class MilestoneTrackingCenterBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('milestoneTrackingCenter', 'Milestone Tracking Center', 'scheduling');
  }
  ...
  async processWorkflow(request: BusinessLogicRequest): Promise<BusinessLogicResponse> {
    try {
      ...
      return {
        ...
        metadata: {
          category: 'scheduling',
          module: 'milestone-tracking-center'
        }
      };
    } catch (error) {
      return {
