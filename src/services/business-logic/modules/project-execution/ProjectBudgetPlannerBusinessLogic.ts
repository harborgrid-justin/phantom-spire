/**
 * Project Budget Planner Business Logic
 */
...
export class ProjectBudgetPlannerBusinessLogic extends BusinessLogicBase {
  constructor() {
    super('projectBudgetPlanner', 'Project Budget Planner', 'budget');
  }
