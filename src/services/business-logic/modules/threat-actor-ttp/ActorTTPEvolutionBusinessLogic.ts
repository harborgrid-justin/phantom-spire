...
const logger = new Logger('ActorTTPEvolutionBusinessLogic');

interface ActorTTPEvolutionAnalytics {
  totalCount: number;
...
export class ActorTTPEvolutionBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<ActorTTPEvolutionAnalytics> {
    try {
