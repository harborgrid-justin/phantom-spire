...
const logger = new Logger('ActorTTPProfilerBusinessLogic');

interface ActorTTPProfilerAnalytics {
  totalCount: number;
...
export class ActorTTPProfilerBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<ActorTTPProfilerAnalytics> {
    try {
