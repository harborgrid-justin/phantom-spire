...
const logger = new Logger('TTPThreatScoringBusinessLogic');

interface TTPThreatScoringAnalytics {
  totalCount: number;
...
export class TTPThreatScoringBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPThreatScoringAnalytics> {
    try {
