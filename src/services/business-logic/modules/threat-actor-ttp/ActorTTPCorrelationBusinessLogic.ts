...
const logger = new Logger('ActorTTPCorrelationBusinessLogic');

interface ActorTTPCorrelationAnalytics {
  totalCount: number;
...
export class ActorTTPCorrelationBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<ActorTTPCorrelationAnalytics> {
    try {
