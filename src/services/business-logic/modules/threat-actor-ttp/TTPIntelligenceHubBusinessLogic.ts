...
const logger = new Logger('TTPIntelligenceHubBusinessLogic');

interface TTPIntelligenceHubAnalytics {
  totalCount: number;
...
export class TTPIntelligenceHubBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<TTPIntelligenceHubAnalytics> {
    try {
