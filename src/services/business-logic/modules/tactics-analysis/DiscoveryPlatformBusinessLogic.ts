...
const logger = new Logger('DiscoveryPlatformBusinessLogic');

interface DiscoveryPlatformAnalytics {
  totalCount: number;
...
export class DiscoveryPlatformBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<DiscoveryPlatformAnalytics> {
    try {
