...
const logger = new Logger('CollectionAnalyzerBusinessLogic');

interface CollectionAnalyzerAnalytics {
  totalCount: number;
...
export class CollectionAnalyzerBusinessLogic {
   ...
   */
  async getAnalytics(): Promise<CollectionAnalyzerAnalytics> {
    try {
