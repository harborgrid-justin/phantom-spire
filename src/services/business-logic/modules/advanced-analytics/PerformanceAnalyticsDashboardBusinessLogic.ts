...
export class PerformanceAnalyticsDashboardBusinessLogic {
  private readonly serviceName =
    'performance-analytics-dashboard-business-logic';
  ...
  private getBusinessRules(): any[] {
    return [
      ...
      },
      {
        name: 'enrichment',
        description:
          'Enrich performance analytics dashboard with contextual data',
        priority: 2,
      ...
      },
      {
        name: 'compliance',
        description:
          'Apply compliance rules to performance analytics dashboard',
        priority: 3,
      ...
      },
      {
        name: 'notification',
        description:
          'Process notifications for performance analytics dashboard',
        priority: 4,
