...
interface TaskPatternDetectorData {
  id: string;
  name: string;
...
export default function TaskPatternDetectorPage() {
  const [data, setData] = useState<TaskPatternDetectorData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-pattern-detector');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskPatternDetectorData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Pattern Detector Item 3',
          status: 'completed',
          priority: 'low',
          category: 'analytics',
          description: 'Automated pattern detection and insights',
      ...
      setData(mockData);
      addNotification('success', 'Task Pattern Detector data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Pattern Detector data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task pattern detector...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Pattern Detector Items</h2>
        </div>
