...
interface TaskSiemIntegrationData {
  id: string;
  name: string;
...
export default function TaskSiemIntegrationPage() {
  const [data, setData] = useState<TaskSiemIntegrationData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-siem-integration');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskSiemIntegrationData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task SIEM Integration Item 3',
          status: 'completed',
          priority: 'low',
          category: 'integration',
          description: 'SIEM platform integration and data flow',
      ...
      setData(mockData);
      addNotification('success', 'Task SIEM Integration data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task SIEM Integration data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task siem integration...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            SIEM platform integration and data flow
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task SIEM Integration Items</h2>
        </div>
