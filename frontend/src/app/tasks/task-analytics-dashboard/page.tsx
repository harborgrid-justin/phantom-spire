...
interface TaskAnalyticsDashboardData {
  id: string;
  name: string;
...
export default function TaskAnalyticsDashboardPage() {
  const [data, setData] = useState<TaskAnalyticsDashboardData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-analytics-dashboard');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskAnalyticsDashboardData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Analytics Dashboard Item 3',
          status: 'completed',
          priority: 'low',
          category: 'analytics',
          description: 'Comprehensive analytics and business intelligence',
      ...
      setData(mockData);
      addNotification('success', 'Task Analytics Dashboard data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Analytics Dashboard data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task analytics dashboard...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Analytics Dashboard Items</h2>
        </div>
