...
interface TaskPerformanceAnalyzerData {
  id: string;
  name: string;
...
export default function TaskPerformanceAnalyzerPage() {
  const [data, setData] = useState<TaskPerformanceAnalyzerData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-performance-analyzer');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskPerformanceAnalyzerData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Performance Analyzer Item 3',
          status: 'completed',
          priority: 'low',
          category: 'execution',
          description: 'Detailed task performance analysis and optimization',
      ...
      setData(mockData);
      addNotification('success', 'Task Performance Analyzer data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Performance Analyzer data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task performance analyzer...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Detailed task performance analysis and optimization
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Performance Analyzer Items</h2>
        </div>
