...
interface TaskKnowledgeBaseData {
  id: string;
  name: string;
...
export default function TaskKnowledgeBasePage() {
  const [data, setData] = useState<TaskKnowledgeBaseData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-knowledge-base');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskKnowledgeBaseData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Knowledge Base Item 3',
          status: 'completed',
          priority: 'low',
          category: 'collaboration',
          description: 'Knowledge management and documentation',
      ...
      setData(mockData);
      addNotification('success', 'Task Knowledge Base data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Knowledge Base data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task knowledge base...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Knowledge Base Items</h2>
        </div>
