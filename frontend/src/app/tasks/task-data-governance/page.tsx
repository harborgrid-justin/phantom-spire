...
interface TaskDataGovernanceData {
  id: string;
  name: string;
...
export default function TaskDataGovernancePage() {
  const [data, setData] = useState<TaskDataGovernanceData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-data-governance');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskDataGovernanceData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Data Governance Item 3',
          status: 'completed',
          priority: 'low',
          category: 'governance',
          description: 'Data governance and privacy compliance',
      ...
      setData(mockData);
      addNotification('success', 'Task Data Governance data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Data Governance data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task data governance...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Data Governance Items</h2>
        </div>
