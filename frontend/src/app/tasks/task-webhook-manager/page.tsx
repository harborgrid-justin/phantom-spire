...
interface TaskWebhookManagerData {
  id: string;
  name: string;
...
export default function TaskWebhookManagerPage() {
  const [data, setData] = useState<TaskWebhookManagerData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-webhook-manager');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskWebhookManagerData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Webhook Manager Item 3',
          status: 'completed',
          priority: 'low',
          category: 'integration',
          description: 'Webhook configuration and management',
      ...
      setData(mockData);
      addNotification('success', 'Task Webhook Manager data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Webhook Manager data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task webhook manager...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Webhook Manager Items</h2>
        </div>
