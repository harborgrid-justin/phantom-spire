...
interface TaskDataConnectorsData {
  id: string;
  name: string;
...
export default function TaskDataConnectorsPage() {
  const [data, setData] = useState<TaskDataConnectorsData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-data-connectors');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskDataConnectorsData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Data Connectors Item 3',
          status: 'completed',
          priority: 'low',
          category: 'integration',
          description: 'Data source connectors and synchronization',
      ...
      setData(mockData);
      addNotification('success', 'Task Data Connectors data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Data Connectors data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task data connectors...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            🔄 Task Data Connectors
          </h1>
          <p className="text-gray-600">
            Data source connectors and synchronization
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Data Connectors Items</h2>
        </div>
