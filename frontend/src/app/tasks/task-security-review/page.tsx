...
interface TaskSecurityReviewData {
  id: string;
  name: string;
...
export default function TaskSecurityReviewPage() {
  const [data, setData] = useState<TaskSecurityReviewData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-security-review');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskSecurityReviewData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Security Review Item 3',
          status: 'completed',
          priority: 'low',
          category: 'governance',
          description: 'Security review and validation processes',
      ...
      setData(mockData);
      addNotification('success', 'Task Security Review data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Security Review data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task security review...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Security review and validation processes
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Security Review Items</h2>
        </div>
