...
export default function TaskApiGatewayPage() {
  const [data, setData] = useState<TaskApiGatewayData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-api-gateway');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskApiGatewayData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task API Gateway Item 3',
          status: 'completed',
          priority: 'low',
          category: 'integration',
          description: 'API management and gateway services',
      ...
      setData(mockData);
      addNotification('success', 'Task API Gateway data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task API Gateway data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task api gateway...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task API Gateway Items</h2>
        </div>
