...
interface TaskExternalServicesData {
  id: string;
  name: string;
...
export default function TaskExternalServicesPage() {
  const [data, setData] = useState<TaskExternalServicesData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-external-services');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskExternalServicesData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task External Services Item 3',
          status: 'completed',
          priority: 'low',
          category: 'integration',
          description: 'External service integration and monitoring',
      ...
      setData(mockData);
      addNotification('success', 'Task External Services data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task External Services data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task external services...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task External Services Items</h2>
        </div>
