...
interface TaskSuccessMetricsData {
  id: string;
  name: string;
...
export default function TaskSuccessMetricsPage() {
  const [data, setData] = useState<TaskSuccessMetricsData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-success-metrics');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskSuccessMetricsData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Success Metrics Item 3',
          status: 'completed',
          priority: 'low',
          category: 'analytics',
          description: 'Success metrics and KPI monitoring',
      ...
      setData(mockData);
      addNotification('success', 'Task Success Metrics data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Success Metrics data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task success metrics...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Success Metrics Items</h2>
        </div>
