...
interface TaskCapacityPlannerData {
  id: string;
  name: string;
...
export default function TaskCapacityPlannerPage() {
  const [data, setData] = useState<TaskCapacityPlannerData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-capacity-planner');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskCapacityPlannerData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Capacity Planner Item 3',
          status: 'completed',
          priority: 'low',
          category: 'execution',
          description: 'Capacity planning and resource forecasting',
      ...
      setData(mockData);
      addNotification('success', 'Task Capacity Planner data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Capacity Planner data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task capacity planner...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Capacity Planner Items</h2>
        </div>
