...
interface TaskRoiCalculatorData {
  id: string;
  name: string;
...
export default function TaskRoiCalculatorPage() {
  const [data, setData] = useState<TaskRoiCalculatorData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-roi-calculator');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskRoiCalculatorData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task ROI Calculator Item 3',
          status: 'completed',
          priority: 'low',
          category: 'analytics',
          description: 'Return on investment analysis and tracking',
      ...
      setData(mockData);
      addNotification('success', 'Task ROI Calculator data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task ROI Calculator data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task roi calculator...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task ROI Calculator Items</h2>
        </div>
