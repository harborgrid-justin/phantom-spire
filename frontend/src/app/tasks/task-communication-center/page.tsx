...
interface TaskCommunicationCenterData {
  id: string;
  name: string;
...
export default function TaskCommunicationCenterPage() {
  const [data, setData] = useState<TaskCommunicationCenterData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-communication-center');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskCommunicationCenterData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Communication Center Item 3',
          status: 'completed',
          priority: 'low',
          category: 'collaboration',
          description: 'Communication tools and messaging platform',
      ...
      setData(mockData);
      addNotification('success', 'Task Communication Center data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Communication Center data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task communication center...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Communication tools and messaging platform
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Communication Center Items</h2>
        </div>
