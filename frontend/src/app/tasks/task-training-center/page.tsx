...
interface TaskTrainingCenterData {
  id: string;
  name: string;
...
export default function TaskTrainingCenterPage() {
  const [data, setData] = useState<TaskTrainingCenterData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('task-management-task-training-center');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: TaskTrainingCenterData[] = [
        {
          id: '1',
        ...
        {
          id: '3',
          name: 'Sample Task Training Center Item 3',
          status: 'completed',
          priority: 'low',
          category: 'collaboration',
          description: 'Training materials and skill development',
      ...
      setData(mockData);
      addNotification('success', 'Task Training Center data loaded successfully');
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to fetch data');
      addNotification('error', 'Failed to load Task Training Center data');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-lg">Loading task training center...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            🎓 Task Training Center
          </h1>
          <p className="text-gray-600">
            Training materials and skill development
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold">Task Training Center Items</h2>
        </div>
