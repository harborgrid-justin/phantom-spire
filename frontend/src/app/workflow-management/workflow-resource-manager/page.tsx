...
interface WorkflowResourceManagerData {
  id: string;
  name: string;
...
export default function WorkflowResourceManagerPage() {
  const [data, setData] = useState<WorkflowResourceManagerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Resource allocation and management for workflows</p>
      </div>
