...
interface ProcessDocumentationHubData {
  id: string;
  name: string;
...
export default function ProcessDocumentationHubPage() {
  const [data, setData] = useState<ProcessDocumentationHubData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Automated process documentation and guides</p>
      </div>
