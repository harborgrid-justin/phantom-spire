...
interface WorkflowSecurityScannerData {
  id: string;
  name: string;
...
export default function WorkflowSecurityScannerPage() {
  const [data, setData] = useState<WorkflowSecurityScannerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Security vulnerability scanning for workflows</p>
      </div>
