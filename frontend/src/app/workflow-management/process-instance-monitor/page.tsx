...
interface ProcessInstanceMonitorData {
  id: string;
  name: string;
...
export default function ProcessInstanceMonitorPage() {
  const [data, setData] = useState<ProcessInstanceMonitorData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Real-time monitoring of workflow instances</p>
      </div>
