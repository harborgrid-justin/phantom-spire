...
interface WorkflowServiceMeshData {
  id: string;
  name: string;
...
export default function WorkflowServiceMeshPage() {
  const [data, setData] = useState<WorkflowServiceMeshData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Service mesh for workflow microservices</p>
      </div>
