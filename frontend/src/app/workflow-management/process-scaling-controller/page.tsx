...
interface ProcessScalingControllerData {
  id: string;
  name: string;
...
export default function ProcessScalingControllerPage() {
  const [data, setData] = useState<ProcessScalingControllerData[]>([]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center">
          ...
          Process Scaling Controller
        </h1>
        <p className="text-gray-600 mt-2">Auto-scaling for workflow execution</p>
      </div>
