...
interface ProcessRiskAssessorData {
  id: string;
  name: string;
...
export default function ProcessRiskAssessorPage() {
  const [data, setData] = useState<ProcessRiskAssessorData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Risk assessment and mitigation planning</p>
      </div>
