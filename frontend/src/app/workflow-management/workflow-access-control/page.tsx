...
interface WorkflowAccessControlData {
  id: string;
  name: string;
...
export default function WorkflowAccessControlPage() {
  const [data, setData] = useState<WorkflowAccessControlData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Role-based access control for workflows</p>
      </div>
