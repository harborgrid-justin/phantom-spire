...
interface WorkflowEncryptionManagerData {
  id: string;
  name: string;
...
export default function WorkflowEncryptionManagerPage() {
  const [data, setData] = useState<WorkflowEncryptionManagerData[]>([]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center">
          ...
          Workflow Encryption Manager
        </h1>
        <p className="text-gray-600 mt-2">Encryption and data protection for workflows</p>
      </div>
