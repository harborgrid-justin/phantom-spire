...
interface WorkflowBottleneckDetectorData {
  id: string;
  name: string;
...
export default function WorkflowBottleneckDetectorPage() {
  const [data, setData] = useState<WorkflowBottleneckDetectorData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Automated bottleneck detection and resolution</p>
      </div>
