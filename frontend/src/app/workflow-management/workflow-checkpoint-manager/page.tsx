...
interface WorkflowCheckpointManagerData {
  id: string;
  name: string;
...
export default function WorkflowCheckpointManagerPage() {
  const [data, setData] = useState<WorkflowCheckpointManagerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Checkpointing and recovery mechanisms</p>
      </div>
