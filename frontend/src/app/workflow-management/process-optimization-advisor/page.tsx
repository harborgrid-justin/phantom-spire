...
interface ProcessOptimizationAdvisorData {
  id: string;
  name: string;
...
export default function ProcessOptimizationAdvisorPage() {
  const [data, setData] = useState<ProcessOptimizationAdvisorData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Intelligent optimization recommendations</p>
      </div>
