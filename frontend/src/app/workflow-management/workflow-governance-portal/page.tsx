...
interface WorkflowGovernancePortalData {
  id: string;
  name: string;
...
export default function WorkflowGovernancePortalPage() {
  const [data, setData] = useState<WorkflowGovernancePortalData[]>([]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center">
          ...
          Workflow Governance Portal
        </h1>
        <p className="text-gray-600 mt-2">Centralized governance and policy management</p>
      </div>
