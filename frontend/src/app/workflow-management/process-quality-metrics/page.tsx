...
interface ProcessQualityMetricsData {
  id: string;
  name: string;
...
export default function ProcessQualityMetricsPage() {
  const [data, setData] = useState<ProcessQualityMetricsData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Quality metrics and SLA monitoring</p>
      </div>
