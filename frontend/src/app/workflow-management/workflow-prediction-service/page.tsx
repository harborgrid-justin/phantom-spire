...
interface WorkflowPredictionServiceData {
  id: string;
  name: string;
...
export default function WorkflowPredictionServicePage() {
  const [data, setData] = useState<WorkflowPredictionServiceData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">AI-powered workflow outcome prediction</p>
      </div>
