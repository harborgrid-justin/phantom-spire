...
interface ProcessValidationEngineData {
  id: string;
  name: string;
...
export default function ProcessValidationEnginePage() {
  const [data, setData] = useState<ProcessValidationEngineData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Workflow validation and compliance checking</p>
      </div>
