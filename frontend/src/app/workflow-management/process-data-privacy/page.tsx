...
interface ProcessDataPrivacyData {
  id: string;
  name: string;
...
export default function ProcessDataPrivacyPage() {
  const [data, setData] = useState<ProcessDataPrivacyData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Data privacy and GDPR compliance management</p>
      </div>
