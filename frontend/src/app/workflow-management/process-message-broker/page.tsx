...
interface ProcessMessageBrokerData {
  id: string;
  name: string;
...
export default function ProcessMessageBrokerPage() {
  const [data, setData] = useState<ProcessMessageBrokerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Message brokering for workflow communication</p>
      </div>
