...
interface ProcessWebhookManagerData {
  id: string;
  name: string;
...
export default function ProcessWebhookManagerPage() {
  const [data, setData] = useState<ProcessWebhookManagerData[]>([]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center">
          ...
          Process Webhook Manager
        </h1>
        <p className="text-gray-600 mt-2">Webhook management for workflow events</p>
      </div>
