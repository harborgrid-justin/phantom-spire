...
interface WorkflowDesignerStudioData {
  id: string;
  name: string;
...
export default function WorkflowDesignerStudioPage() {
  const [data, setData] = useState<WorkflowDesignerStudioData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Advanced visual workflow design and modeling environment</p>
      </div>
