...
interface WorkflowStateManagerData {
  id: string;
  name: string;
...
export default function WorkflowStateManagerPage() {
  const [data, setData] = useState<WorkflowStateManagerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">State management and persistence for workflows</p>
      </div>
