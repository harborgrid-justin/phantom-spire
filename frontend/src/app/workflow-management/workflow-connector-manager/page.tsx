...
interface WorkflowConnectorManagerData {
  id: string;
  name: string;
...
export default function WorkflowConnectorManagerPage() {
  const [data, setData] = useState<WorkflowConnectorManagerData[]>([]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center">
          ...
          Workflow Connector Manager
        </h1>
        <p className="text-gray-600 mt-2">Third-party system connectors and adapters</p>
      </div>
