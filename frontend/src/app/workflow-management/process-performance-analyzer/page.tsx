...
interface ProcessPerformanceAnalyzerData {
  id: string;
  name: string;
...
export default function ProcessPerformanceAnalyzerPage() {
  const [data, setData] = useState<ProcessPerformanceAnalyzerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Performance analysis and optimization insights</p>
      </div>
