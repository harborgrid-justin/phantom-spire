...
interface ProcessMiningEngineData {
  id: string;
  name: string;
...
export default function ProcessMiningEnginePage() {
  const [data, setData] = useState<ProcessMiningEngineData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Process mining and discovery from execution logs</p>
      </div>
