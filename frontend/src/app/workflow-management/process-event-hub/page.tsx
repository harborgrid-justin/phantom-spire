...
export default function ProcessEventHubPage() {
  const [data, setData] = useState<ProcessEventHubData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Event-driven workflow integration hub</p>
      </div>
