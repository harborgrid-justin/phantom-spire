...
interface WorkflowImpactAnalyzerData {
  id: string;
  name: string;
...
export default function WorkflowImpactAnalyzerPage() {
  const [data, setData] = useState<WorkflowImpactAnalyzerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Impact analysis for workflow changes</p>
      </div>
