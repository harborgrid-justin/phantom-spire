...
interface ProcessQueueControllerData {
  id: string;
  name: string;
...
export default function ProcessQueueControllerPage() {
  const [data, setData] = useState<ProcessQueueControllerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Workflow queue management and prioritization</p>
      </div>
