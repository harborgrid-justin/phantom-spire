...
interface WorkflowComplianceCheckerData {
  id: string;
  name: string;
...
export default function WorkflowComplianceCheckerPage() {
  const [data, setData] = useState<WorkflowComplianceCheckerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Automated compliance checking and validation</p>
      </div>
