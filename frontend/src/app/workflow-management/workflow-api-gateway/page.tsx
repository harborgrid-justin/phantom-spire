...
interface WorkflowApiGatewayData {
  id: string;
  name: string;
...
export default function WorkflowApiGatewayPage() {
  const [data, setData] = useState<WorkflowApiGatewayData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">API gateway for workflow services</p>
      </div>
