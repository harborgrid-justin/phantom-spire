...
interface WorkflowSchedulerServiceData {
  id: string;
  name: string;
...
export default function WorkflowSchedulerServicePage() {
  const [data, setData] = useState<WorkflowSchedulerServiceData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Advanced workflow scheduling and timing</p>
      </div>
