...
interface WorkflowVersionControlData {
  id: string;
  name: string;
...
export default function WorkflowVersionControlPage() {
  const [data, setData] = useState<WorkflowVersionControlData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Version control and change management for workflows</p>
      </div>
