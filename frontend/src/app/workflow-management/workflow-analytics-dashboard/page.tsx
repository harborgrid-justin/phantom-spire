...
interface WorkflowAnalyticsDashboardData {
  id: string;
  name: string;
...
export default function WorkflowAnalyticsDashboardPage() {
  const [data, setData] = useState<WorkflowAnalyticsDashboardData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Comprehensive workflow analytics and insights</p>
      </div>
