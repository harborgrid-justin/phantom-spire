...
interface ProcessChangeApproverData {
  id: string;
  name: string;
...
export default function ProcessChangeApproverPage() {
  const [data, setData] = useState<ProcessChangeApproverData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Change approval and workflow management</p>
      </div>
