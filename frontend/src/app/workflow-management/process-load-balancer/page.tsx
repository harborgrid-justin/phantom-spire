...
interface ProcessLoadBalancerData {
  id: string;
  name: string;
...
export default function ProcessLoadBalancerPage() {
  const [data, setData] = useState<ProcessLoadBalancerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Load balancing for distributed workflow execution</p>
      </div>
