...
interface ProcessModelRepositoryData {
  id: string;
  name: string;
...
export default function ProcessModelRepositoryPage() {
  const [data, setData] = useState<ProcessModelRepositoryData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Centralized repository for workflow templates and models</p>
      </div>
