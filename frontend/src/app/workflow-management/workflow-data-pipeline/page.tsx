...
interface WorkflowDataPipelineData {
  id: string;
  name: string;
...
export default function WorkflowDataPipelinePage() {
  const [data, setData] = useState<WorkflowDataPipelineData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Data pipeline integration for workflows</p>
      </div>
