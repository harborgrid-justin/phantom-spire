...
interface WorkflowComplianceMonitorData {
  id: string;
  name: string;
...
export default function WorkflowComplianceMonitorPage() {
  const [data, setData] = useState<WorkflowComplianceMonitorData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Compliance monitoring and audit trail</p>
      </div>
