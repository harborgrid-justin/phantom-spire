...
interface WorkflowTransformationEngineData {
  id: string;
  name: string;
...
export default function WorkflowTransformationEnginePage() {
  const [data, setData] = useState<WorkflowTransformationEngineData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Data transformation and mapping engine</p>
      </div>
