...
interface WorkflowTemplateManagerData {
  id: string;
  name: string;
...
export default function WorkflowTemplateManagerPage() {
  const [data, setData] = useState<WorkflowTemplateManagerData[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Template creation and management system</p>
      </div>
