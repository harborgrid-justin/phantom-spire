...
export default function ThreatScoringPage() {
  const { 
    ...
    notifications,
    removeNotification 
  } = useServicePage('threat-intel-threat-detection-threat-scoring');
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-red-800 mb-2">
            📊 Error Loading 📊 Threat Scoring Matrix
          </h2>
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Intelligent threat scoring and risk assessment framework</p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900">
                  📊 Threat Scoring Matrix Operations
                </h2>
              </div>
              <div className="p-6">
                {filteredData.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">
                      No 📊 Threat Scoring Matrix Data
                    </h3>
                    <p className="text-gray-600 mb-4">
                      Get started by initializing the 📊 threat scoring matrix service.
                    </p>
                    <button
