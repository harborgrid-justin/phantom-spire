...
const QuarantineManagementPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/v1/xdr/quarantine', {
        headers: {
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This module provides threat containment system. 
...
export default QuarantineManagementPage;