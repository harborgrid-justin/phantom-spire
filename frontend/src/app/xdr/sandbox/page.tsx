...
const SandboxAnalysisPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/v1/xdr/sandbox/analyze', {
        headers: {
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This module provides malware analysis sandbox. 
...
export default SandboxAnalysisPage;