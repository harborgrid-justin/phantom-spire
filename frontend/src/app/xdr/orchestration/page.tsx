...
const OrchestrationEnginePage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/v1/xdr/orchestration/response', {
        headers: {
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This module provides security orchestration platform. 
...
export default OrchestrationEnginePage;