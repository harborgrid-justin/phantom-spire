...
const ZeroTrustEnforcementPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/v1/xdr/zero-trust/enforce', {
        headers: {
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This module provides zero trust security model. 
...
export default ZeroTrustEnforcementPage;