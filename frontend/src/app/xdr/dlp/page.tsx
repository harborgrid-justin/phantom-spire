...
const DataLossPreventionPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/v1/xdr/dlp', {
        headers: {
          ...
          <Card sx={{ mt: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This module provides prevent sensitive data exfiltration. 
...
export default DataLossPreventionPage;