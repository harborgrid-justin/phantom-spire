...
export default function RiskDashboardsPage() {
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('vendor-risk-risk-monitoring-risk-dashboards');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-lg font-medium text-gray-900">Loading 📈 Risk Dashboards...</div>
          ...
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Comprehensive risk visualization and analytics dashboards
              </p>
            </div>
