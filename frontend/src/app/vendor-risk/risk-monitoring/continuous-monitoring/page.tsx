...
export default function ContinuousMonitoringPage() {
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('vendor-risk-risk-monitoring-continuous-monitoring');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-lg font-medium text-gray-900">Loading 📡 Continuous Monitoring...</div>
          ...
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Real-time risk monitoring and automated surveillance
              </p>
            </div>
