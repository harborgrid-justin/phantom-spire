...
interface MilestoneManagementData {
  id: string;
  title: string;
  status: string;
  createdAt: string;
...
export default function MilestoneManagementPage() {
  const [data, setData] = useState<MilestoneManagementData[]>([]);
  ...
  const {
    ...
    addNotification,
    removeNotification,
  } = useServicePage('case-management-milestone-management');
  ...
  const fetchData = async () => {
    try {
      ...
      const mockData: MilestoneManagementData[] = [
        {
          id: '1',
      ...
      addNotification({
        type: 'success',
        message: 'Milestone Management data loaded successfully',
        duration: 3000
      });
    } catch (error) {
      console.error('Error fetching milestone-management data:', error);
      addNotification({
        type: 'error',
        message: 'Failed to load Milestone Management data',
        duration: 5000
      });
    } finally {
      setLoading(false);
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Investigation milestone tracking and reporting</p>
            </div>
          ...
          {data.length === 0 && (
            <div className="text-center py-12">
              <div className="text-gray-500">
                ...
                <p className="text-sm">Get started by creating your first milestone management entry.</p>
              </div>
            </div>
          )}
        </div>
