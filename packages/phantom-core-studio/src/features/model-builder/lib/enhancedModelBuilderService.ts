...
import { ServiceDefinition, ServiceContext, BusinessLogicRequest, ProcessResult, ValidationResult, RuleEnforcementResult, InsightResult, MetricResult, TrendPrediction, IntegrationResult, FeatureEngineeringResult, FeatureSelectionResult, EngineeredFeature } from '../../../lib/core-logic/types/business-logic.types';
import { ModelConfig, AutoMLResult, UploadedData, ModelResult, EnsembleResult } from '../types/modelBuilder.types';
...
const ENHANCED_MODEL_BUILDER_SERVICE_DEFINITION: ServiceDefinition = {
    ...
    dependencies: ['@phantom-core/ml-core'],
    status: 'ready',
    metadata: {
