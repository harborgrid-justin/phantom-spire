...
Advanced threat intelligence core with comprehensive intelligence gathering, analysis, and correlation engine
...
```javascript
const phantom-intel-core = require('phantom-intel-core');
...
cd phantom-spire/packages/phantom-intel-core
