...
impl PostgresStorage {
    ...
    async fn initialize_database(&self) -> Result<(), StorageError> {
        ...
        ", &[]).await.map_err(|e| StorageError::Internal(format!("Failed to create threat_actors table: {}", e)))?;
        ...
        ", &[]).await.map_err(|e| StorageError::Internal(format!("Failed to create campaigns table: {}", e)))?;
        ...
        ", &[]).await.map_err(|e| StorageError::Internal(format!("Failed to create attribution_analyses table: {}", e)))?;
        ...
        ", &[]).await.map_err(|e| StorageError::Internal(format!("Failed to create behavioral_analyses table: {}", e)))?;

        // Create indexes for better performance
        client.execute("CREATE INDEX IF NOT EXISTS idx_threat_actors_type ON threat_actors(actor_type)", &[]).await?;
        client.execute("CREATE INDEX IF NOT EXISTS idx_threat_actors_country ON threat_actors(origin_country)", &[]).await?;
        client.execute("CREATE INDEX IF NOT EXISTS idx_threat_actors_status ON threat_actors(status)", &[]).await?;
        client.execute("CREATE INDEX IF NOT EXISTS idx_threat_actors_confidence ON threat_actors(confidence_score)", &[]).await?;
        client.execute("CREATE INDEX IF NOT EXISTS idx_campaigns_actor_id ON campaigns(actor_id)", &[]).await?;
        client.execute("CREATE INDEX IF NOT EXISTS idx_campaigns_status ON campaigns(status)", &[]).await?;
    ...
    fn row_to_threat_actor(row: &Row) -> Result<ThreatActor, StorageError> {
        Ok(ThreatActor {
            id: row.try_get("id").map_err(|e| StorageError::Serialization(format!("Failed to get id: {}", e)))?,
            name: row.try_get("name").map_err(|e| StorageError::Serialization(format!("Failed to get name: {}", e)))?,
            aliases: serde_json::from_value(row.try_get("aliases").map_err(|e| StorageError::Serialization(format!("Failed to get aliases: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize aliases: {}", e)))?,
            actor_type: serde_json::from_value(row.try_get("actor_type").map_err(|e| StorageError::Serialization(format!("Failed to get actor_type: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize actor_type: {}", e)))?,
            sophistication_level: serde_json::from_value(row.try_get("sophistication_level").map_err(|e| StorageError::Serialization(format!("Failed to get sophistication_level: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize sophistication_level: {}", e)))?,
            motivation: serde_json::from_value(row.try_get("motivation").map_err(|e| StorageError::Serialization(format!("Failed to get motivation: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize motivation: {}", e)))?,
            origin_country: row.try_get("origin_country").map_err(|e| StorageError::Serialization(format!("Failed to get origin_country: {}", e)))?,
            first_observed: row.try_get("first_observed").map_err(|e| StorageError::Serialization(format!("Failed to get first_observed: {}", e)))?,
            last_activity: row.try_get("last_activity").map_err(|e| StorageError::Serialization(format!("Failed to get last_activity: {}", e)))?,
            status: serde_json::from_value(row.try_get("status").map_err(|e| StorageError::Serialization(format!("Failed to get status: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize status: {}", e)))?,
            confidence_score: row.try_get("confidence_score").map_err(|e| StorageError::Serialization(format!("Failed to get confidence_score: {}", e)))?,
            attribution_confidence: row.try_get("attribution_confidence").map_err(|e| StorageError::Serialization(format!("Failed to get attribution_confidence: {}", e)))?,
            capabilities: serde_json::from_value(row.try_get("capabilities").map_err(|e| StorageError::Serialization(format!("Failed to get capabilities: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize capabilities: {}", e)))?,
            infrastructure: serde_json::from_value(row.try_get("infrastructure").map_err(|e| StorageError::Serialization(format!("Failed to get infrastructure: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize infrastructure: {}", e)))?,
            tactics: serde_json::from_value(row.try_get("tactics").map_err(|e| StorageError::Serialization(format!("Failed to get tactics: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize tactics: {}", e)))?,
            techniques: serde_json::from_value(row.try_get("techniques").map_err(|e| StorageError::Serialization(format!("Failed to get techniques: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize techniques: {}", e)))?,
            procedures: serde_json::from_value(row.try_get("procedures").map_err(|e| StorageError::Serialization(format!("Failed to get procedures: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize procedures: {}", e)))?,
            targets: serde_json::from_value(row.try_get("targets").map_err(|e| StorageError::Serialization(format!("Failed to get targets: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize targets: {}", e)))?,
            campaigns: serde_json::from_value(row.try_get("campaigns").map_err(|e| StorageError::Serialization(format!("Failed to get campaigns: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize campaigns: {}", e)))?,
            associated_malware: serde_json::from_value(row.try_get("associated_malware").map_err(|e| StorageError::Serialization(format!("Failed to get associated_malware: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize associated_malware: {}", e)))?,
            iocs: serde_json::from_value(row.try_get("iocs").map_err(|e| StorageError::Serialization(format!("Failed to get iocs: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize iocs: {}", e)))?,
            relationships: serde_json::from_value(row.try_get("relationships").map_err(|e| StorageError::Serialization(format!("Failed to get relationships: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize relationships: {}", e)))?,
            metadata: serde_json::from_value(row.try_get("metadata").map_err(|e| StorageError::Serialization(format!("Failed to get metadata: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize metadata: {}", e)))?,
        })
    }
    ...
    fn row_to_campaign(row: &Row) -> Result<Campaign, StorageError> {
        Ok(Campaign {
            id: row.try_get("id").map_err(|e| StorageError::Serialization(format!("Failed to get id: {}", e)))?,
            name: row.try_get("name").map_err(|e| StorageError::Serialization(format!("Failed to get name: {}", e)))?,
            actor_id: row.try_get("actor_id").map_err(|e| StorageError::Serialization(format!("Failed to get actor_id: {}", e)))?,
            start_date: row.try_get("start_date").map_err(|e| StorageError::Serialization(format!("Failed to get start_date: {}", e)))?,
            end_date: row.try_get("end_date").map_err(|e| StorageError::Serialization(format!("Failed to get end_date: {}", e)))?,
            status: serde_json::from_value(row.try_get("status").map_err(|e| StorageError::Serialization(format!("Failed to get status: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize status: {}", e)))?,
            objectives: serde_json::from_value(row.try_get("objectives").map_err(|e| StorageError::Serialization(format!("Failed to get objectives: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize objectives: {}", e)))?,
            targets: serde_json::from_value(row.try_get("targets").map_err(|e| StorageError::Serialization(format!("Failed to get targets: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize targets: {}", e)))?,
            ttps: serde_json::from_value(row.try_get("ttps").map_err(|e| StorageError::Serialization(format!("Failed to get ttps: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize ttps: {}", e)))?,
            malware_families: serde_json::from_value(row.try_get("malware_families").map_err(|e| StorageError::Serialization(format!("Failed to get malware_families: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize malware_families: {}", e)))?,
            iocs: serde_json::from_value(row.try_get("iocs").map_err(|e| StorageError::Serialization(format!("Failed to get iocs: {}", e)))?)
                .map_err(|e| StorageError::Serialization(format!("Failed to deserialize iocs: {}", e)))?,
            impact_assessment: serde_json::from_value(row.try_get("impact_assessment").map_err(|e| StorageError::Serialization(format!("Failed to get impact_assessment: {}", e)))?)
...
impl ThreatActorStorage for PostgresStorage {
    ...
    async fn health_check(&self) -> Result<HealthStatus, StorageError> {
        ...
        let row = client.query_one("SELECT COUNT(*) as count FROM threat_actors", &[]).await
    ...
    async fn get_threat_actor(&self, id: &str) -> Result<Option<ThreatActor>, StorageError> {
        ...
        ", &[&id]).await.map_err(|e| StorageError::Internal(format!("Failed to get threat actor: {}", e)))?;
    ...
    async fn get_threat_actor_batch(&self, ids: &[String]) -> Result<Vec<ThreatActor>, StorageError> {
        ...
        ", &[&ids_json]).await.map_err(|e| StorageError::Internal(format!("Failed to get threat actors batch: {}", e)))?;
    ...
    async fn search_threat_actors(&self, criteria: &ThreatActorSearchCriteria) -> Result<Vec<ThreatActor>, StorageError> {
        ...
        let mut query = "SELECT id, name, aliases, actor_type, sophistication_level, motivation,
                                ...
                                infrastructure, tactics, techniques, procedures, targets,
                                campaigns, associated_malware, iocs, relationships, metadata
                         FROM threat_actors WHERE 1=1".to_string();
        ...
        if let Some(ref actor_types) = criteria.actor_types {
            ...
            let types_json = serde_json::to_value(actor_types)
                .map_err(|e| StorageError::Serialization(format!("Failed to serialize actor_types: {}", e)))?;
            params.push(&types_json);
        }

        if let Some(ref sophistication_levels) = criteria.sophistication_levels {
            param_count += 1;
            query.push_str(&format!(" AND sophistication_level = ANY(${})", param_count));
            let levels_json = serde_json::to_value(sophistication_levels)
                .map_err(|e| StorageError::Serialization(format!("Failed to serialize sophistication_levels: {}", e)))?;
        ...
        if let Some(ref origin_countries) = criteria.origin_countries {
            ...
            let countries_json = serde_json::to_value(origin_countries)
                .map_err(|e| StorageError::Serialization(format!("Failed to serialize origin_countries: {}", e)))?;
        ...
        if let Some(ref activity_status) = criteria.activity_status {
            ...
            let status_json = serde_json::to_value(activity_status)
                .map_err(|e| StorageError::Serialization(format!("Failed to serialize activity_status: {}", e)))?;
    ...
    async fn list_threat_actor_ids(&self) -> Result<Vec<String>, StorageError> {
        ...
        let rows = client.query("SELECT id FROM threat_actors ORDER BY id", &[]).await
            .map_err(|e| StorageError::Internal(format!("Failed to list threat actor ids: {}", e)))?;

        let mut ids = Vec::new();
        for row in rows {
            ids.push(row.try_get("id").map_err(|e| StorageError::Serialization(format!("Failed to get id: {}", e)))?);
        }
    ...
    async fn delete_threat_actor(&self, id: &str) -> Result<bool, StorageError> {
        ...
        let result = client.execute("DELETE FROM threat_actors WHERE id = $1", &[&id]).await
    ...
    async fn store_campaign(&self, campaign: &Campaign) -> Result<(), StorageError> {
        ...
        ", &[
            ...
            &campaign.start_date,
            &campaign.end_date,
            &serde_json::to_value(&campaign.status).map_err(|e| StorageError::Serialization(format!("Failed to serialize status: {}", e)))?,
            &serde_json::to_value(&campaign.objectives).map_err(|e| StorageError::Serialization(format!("Failed to serialize objectives: {}", e)))?,
            &serde_json::to_value(&campaign.targets).map_err(|e| StorageError::Serialization(format!("Failed to serialize targets: {}", e)))?,
            &serde_json::to_value(&campaign.ttps).map_err(|e| StorageError::Serialization(format!("Failed to serialize ttps: {}", e)))?,
            &serde_json::to_value(&campaign.malware_families).map_err(|e| StorageError::Serialization(format!("Failed to serialize malware_families: {}", e)))?,
            &serde_json::to_value(&campaign.iocs).map_err(|e| StorageError::Serialization(format!("Failed to serialize iocs: {}", e)))?,
            &serde_json::to_value(&campaign.impact_assessment).map_err(|e| StorageError::Serialization(format!("Failed to serialize impact_assessment: {}", e)))?,
        ]).await.map_err(|e| StorageError::Internal(format!("Failed to store campaign: {}", e)))?;
    ...
    async fn get_campaign(&self, id: &str) -> Result<Option<Campaign>, StorageError> {
        ...
        ", &[&id]).await.map_err(|e| StorageError::Internal(format!("Failed to get campaign: {}", e)))?;
    ...
    async fn search_campaigns(&self, actor_id: Option<&str>, status: Option<CampaignStatus>) -> Result<Vec<Campaign>, StorageError> {
        ...
        let mut query = "SELECT id, name, actor_id, start_date, end_date, status,
                                objectives, targets, ttps, malware_families, iocs, impact_assessment
                         FROM campaigns WHERE 1=1".to_string();
        let mut params: Vec<&(dyn tokio_postgres::types::ToSql + Sync)> = Vec::new();
    ...
    async fn store_attribution_analysis(&self, analysis: &AttributionAnalysis) -> Result<(), StorageError> {
        ...
        ", &[
            ...
            &serde_json::to_value(&analysis.alternative_attributions).map_err(|e| StorageError::Serialization(format!("Failed to serialize alternative_attributions: {}", e)))?,
            &analysis.confidence_score,
            &serde_json::to_value(&analysis.evidence_summary).map_err(|e| StorageError::Serialization(format!("Failed to serialize evidence_summary: {}", e)))?,
            &analysis.analysis_timestamp,
        ]).await.map_err(|e| StorageError::Internal(format!("Failed to store attribution analysis: {}", e)))?;
    ...
    async fn get_attribution_analysis(&self, actor_id: &str) -> Result<Vec<AttributionAnalysis>, StorageError> {
        ...
        ", &[&actor_id]).await.map_err(|e| StorageError::Internal(format!("Failed to get attribution analysis: {}", e)))?;

        let mut analyses = Vec::new();
        for row in rows {
            analyses.push(AttributionAnalysis {
                primary_attribution: row.try_get("primary_attribution").map_err(|e| StorageError::Serialization(format!("Failed to get primary_attribution: {}", e)))?,
                alternative_attributions: serde_json::from_value(row.try_get("alternative_attributions").map_err(|e| StorageError::Serialization(format!("Failed to get alternative_attributions: {}", e)))?)
                    .map_err(|e| StorageError::Serialization(format!("Failed to deserialize alternative_attributions: {}", e)))?,
                confidence_score: row.try_get("confidence_score").map_err(|e| StorageError::Serialization(format!("Failed to get confidence_score: {}", e)))?,
                evidence_summary: serde_json::from_value(row.try_get("evidence_summary").map_err(|e| StorageError::Serialization(format!("Failed to get evidence_summary: {}", e)))?)
                    .map_err(|e| StorageError::Serialization(format!("Failed to deserialize evidence_summary: {}", e)))?,
                analysis_timestamp: row.try_get("analysis_timestamp").map_err(|e| StorageError::Serialization(format!("Failed to get analysis_timestamp: {}", e)))?,
            });
        }
    ...
    async fn store_behavioral_analysis(&self, analysis: &BehavioralAnalysis) -> Result<(), StorageError> {
        ...
        ", &[
            &analysis.actor_id,
            &serde_json::to_value(&analysis.behavioral_patterns).map_err(|e| StorageError::Serialization(format!("Failed to serialize behavioral_patterns: {}", e)))?,
            &serde_json::to_value(&analysis.operational_patterns).map_err(|e| StorageError::Serialization(format!("Failed to serialize operational_patterns: {}", e)))?,
            &serde_json::to_value(&analysis.evolution_analysis).map_err(|e| StorageError::Serialization(format!("Failed to serialize evolution_analysis: {}", e)))?,
            &serde_json::to_value(&analysis.predictive_indicators).map_err(|e| StorageError::Serialization(format!("Failed to serialize predictive_indicators: {}", e)))?,
        ]).await.map_err(|e| StorageError::Internal(format!("Failed to store behavioral analysis: {}", e)))?;
    ...
    async fn get_behavioral_analysis(&self, actor_id: &str) -> Result<Option<BehavioralAnalysis>, StorageError> {
        ...
        ", &[&actor_id]).await.map_err(|e| StorageError::Internal(format!("Failed to get behavioral analysis: {}", e)))?;

        match row {
            Some(row) => Ok(Some(BehavioralAnalysis {
                actor_id: row.try_get("actor_id").map_err(|e| StorageError::Serialization(format!("Failed to get actor_id: {}", e)))?,
                behavioral_patterns: serde_json::from_value(row.try_get("behavioral_patterns").map_err(|e| StorageError::Serialization(format!("Failed to get behavioral_patterns: {}", e)))?)
                    .map_err(|e| StorageError::Serialization(format!("Failed to deserialize behavioral_patterns: {}", e)))?,
                operational_patterns: serde_json::from_value(row.try_get("operational_patterns").map_err(|e| StorageError::Serialization(format!("Failed to get operational_patterns: {}", e)))?)
                    .map_err(|e| StorageError::Serialization(format!("Failed to deserialize operational_patterns: {}", e)))?,
                evolution_analysis: serde_json::from_value(row.try_get("evolution_analysis").map_err(|e| StorageError::Serialization(format!("Failed to get evolution_analysis: {}", e)))?)
                    .map_err(|e| StorageError::Serialization(format!("Failed to deserialize evolution_analysis: {}", e)))?,
                predictive_indicators: serde_json::from_value(row.try_get("predictive_indicators").map_err(|e| StorageError::Serialization(format!("Failed to get predictive_indicators: {}", e)))?)
    ...
    async fn update_actor_confidence(&self, actor_id: &str, confidence: f64) -> Result<(), StorageError> {
        ...
        client.execute("UPDATE threat_actors SET confidence_score = $1, updated_at = NOW() WHERE id = $2", &[&confidence, &actor_id]).await
    ...
    async fn get_actors_by_type(&self, actor_type: ActorType) -> Result<Vec<ThreatActor>, StorageError> {
        ...
        let type_json = serde_json::to_value(&actor_type)
        ...
        ", &[&type_json]).await.map_err(|e| StorageError::Internal(format!("Failed to get actors by type: {}", e)))?;
    ...
    async fn get_actors_by_sophistication(&self, level: SophisticationLevel) -> Result<Vec<ThreatActor>, StorageError> {
        ...
        ", &[&level_json]).await.map_err(|e| StorageError::Internal(format!("Failed to get actors by sophistication: {}", e)))?;
    ...
    async fn get_actors_by_country(&self, country: &str) -> Result<Vec<ThreatActor>, StorageError> {
        ...
        ", &[&country]).await.map_err(|e| StorageError::Internal(format!("Failed to get actors by country: {}", e)))?;
    ...
    async fn get_statistics(&self) -> Result<StorageStatistics, StorageError> {
        ...
        let threat_actor_count: i64 = client.query_one("SELECT COUNT(*) FROM threat_actors", &[]).await?
            .try_get(0).map_err(|e| StorageError::Internal(format!("Failed to get threat actor count: {}", e)))?;

        let campaign_count: i64 = client.query_one("SELECT COUNT(*) FROM campaigns", &[]).await?
            .try_get(0).map_err(|e| StorageError::Internal(format!("Failed to get campaign count: {}", e)))?;

        let attribution_count: i64 = client.query_one("SELECT COUNT(*) FROM attribution_analyses", &[]).await?
            .try_get(0).map_err(|e| StorageError::Internal(format!("Failed to get attribution count: {}", e)))?;

        let behavioral_count: i64 = client.query_one("SELECT COUNT(*) FROM behavioral_analyses", &[]).await?
            .try_get(0).map_err(|e| StorageError::Internal(format!("Failed to get behavioral count: {}", e)))?;
