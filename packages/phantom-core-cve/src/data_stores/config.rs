...
impl Default for RedisConfig {
    fn default() -> Self {
        Self {
            ...
            key_prefix: "phantom_cve:".to_string(),
            max_connections: 10,
...
impl Default for PostgresConfig {
    fn default() -> Self {
        Self {
            url: "postgresql://localhost:5432/phantom_cve".to_string(),
            max_connections: 10,
            min_connections: 2,
            ...
            schema_name: "cve".to_string(),
            table_prefix: "pc_".to_string(),
            enable_ssl: true,
...
impl Default for MongoDBConfig {
    fn default() -> Self {
        Self {
            ...
            database_name: "phantom_cve".to_string(),
            collection_prefix: "pc_".to_string(),
            max_pool_size: 10,
            min_pool_size: 2,
            connection_timeout_ms: 30000,
