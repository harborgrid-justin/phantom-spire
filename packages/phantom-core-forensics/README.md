...
Digital forensics and incident analysis core with evidence collection and timeline reconstruction

## Installation

```bash
npm install @phantom-core/forensics
```

## Usage

```javascript
const phantom-forensics-core = require('@phantom-core/forensics');
...
cd phantom-core/packages/phantom-core-forensics
