              ...
              <CardContent>
                ...
                <List>
                  {frameworks.map((framework) => (
                    <ListItem key={framework.id} button onClick={() => setSelectedFramework(framework)}>
                      <ListItemIcon>
                    ...
                    >
                      <ListItemIcon>
                        <Badge
                          ...
                          color="error"
                          invisible={framework.remediation.required === 0}
                        >
                          {getStatusIcon(framework.status)}
                        </Badge>
                      </ListItemIcon>
                ...
                <Grid container spacing={2} sx={{ mb: 3 }}>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    <Chip
                      ...
                      color={getRiskColor(selectedFramework.riskLevel) as any}
                      size="small"
                    />
                  </Grid>
                  <Grid item xs={6} md={3}>
