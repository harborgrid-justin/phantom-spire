/**
 * Jest test for phantom-ioc-core napi-rs package
...
const packagePath = '/home/runner/work/phantom-spire/phantom-spire/packages/phantom-ioc-core';

describe('phantom-ioc-core napi package', () => {
  describe('Package Structure', () => {
    ...
    it('should have napi configuration in package.json', () => {
      ...
      console.log('✅ phantom-ioc-core: NAPI configured as', packageJson.napi.name);
    });
    ...
    it('should have Rust napi dependencies in Cargo.toml', () => {
      ...
      console.log('✅ phantom-ioc-core: Rust napi dependencies configured');
    });
  });
  ...
  describe('NAPI Implementation Status', () => {
    it('should check for built napi files and test if available', () => {
      ...
      const napiNodeExists = existsSync(join(packagePath, 'phantom-ioc-core.linux-x64-gnu.node'));
      
      if (indexJsExists && indexDtsExists && napiNodeExists) {
        console.log('✅ phantom-ioc-core: Built files found, ready for napi testing');
        ...
        console.log('🚧 phantom-ioc-core: Build files not found, package needs successful build');
    ...
    it('should verify Rust source has napi bindings', () => {
      ...
      if (existsSync(libRsPath)) {
        ...
        console.log('✅ phantom-ioc-core: Rust source contains napi bindings');
      } else {
        console.log('⚠️  phantom-ioc-core: lib.rs not found');
  ...
  describe('Future Integration Tests', () => {
    it('should be ready for comprehensive napi function testing', () => {
      ...
      console.log('📋 phantom-ioc-core: Package structure verified');
