/**
 * Jest test for phantom-reputation-core napi-rs package
...
const packagePath = '/home/runner/work/phantom-spire/phantom-spire/packages/phantom-reputation-core';

describe('phantom-reputation-core napi package', () => {
  describe('Package Structure', () => {
    ...
    it('should have napi configuration in package.json', () => {
      ...
      console.log('✅ phantom-reputation-core: NAPI configured as', packageJson.napi.name);
    });
    ...
    it('should have Rust napi dependencies in Cargo.toml', () => {
      ...
      console.log('✅ phantom-reputation-core: Rust napi dependencies configured');
    });
  });
  ...
  describe('NAPI Implementation Status', () => {
    it('should check for built napi files and test if available', () => {
      ...
      const napiNodeExists = existsSync(join(packagePath, 'phantom-reputation-core.linux-x64-gnu.node'));
      
      if (indexJsExists && indexDtsExists && napiNodeExists) {
        console.log('✅ phantom-reputation-core: Built files found, ready for napi testing');
        ...
        console.log('🚧 phantom-reputation-core: Build files not found, package needs successful build');
    ...
    it('should verify Rust source has napi bindings', () => {
      ...
      if (existsSync(libRsPath)) {
        ...
        console.log('✅ phantom-reputation-core: Rust source contains napi bindings');
      } else {
        console.log('⚠️  phantom-reputation-core: lib.rs not found');
  ...
  describe('Future Integration Tests', () => {
    it('should be ready for comprehensive napi function testing', () => {
      ...
      console.log('📋 phantom-reputation-core: Package structure verified');
