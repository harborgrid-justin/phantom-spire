/**
 * Jest test for phantom-intel-core napi-rs package
...
const packagePath = '/home/runner/work/phantom-spire/phantom-spire/packages/phantom-intel-core';

describe('phantom-intel-core napi package', () => {
  describe('Package Structure', () => {
    ...
    it('should have napi configuration in package.json', () => {
      ...
      console.log('✅ phantom-intel-core: NAPI configured as', packageJson.napi.name);
    });
    ...
    it('should have Rust napi dependencies in Cargo.toml', () => {
      ...
      console.log('✅ phantom-intel-core: Rust napi dependencies configured');
    });
  });
  ...
  describe('NAPI Implementation Status', () => {
    it('should check for built napi files and test if available', () => {
      ...
      const napiNodeExists = existsSync(join(packagePath, 'phantom-intel-core.linux-x64-gnu.node'));
      
      if (indexJsExists && indexDtsExists && napiNodeExists) {
        console.log('✅ phantom-intel-core: Built files found, ready for napi testing');
        ...
        console.log('🚧 phantom-intel-core: Build files not found, package needs successful build');
    ...
    it('should verify Rust source has napi bindings', () => {
      ...
      if (existsSync(libRsPath)) {
        ...
        console.log('✅ phantom-intel-core: Rust source contains napi bindings');
      } else {
        console.log('⚠️  phantom-intel-core: lib.rs not found');
  ...
  describe('Future Integration Tests', () => {
    it('should be ready for comprehensive napi function testing', () => {
      ...
      console.log('📋 phantom-intel-core: Package structure verified');
